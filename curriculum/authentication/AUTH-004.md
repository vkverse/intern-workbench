...
id: AUTH-004
phase: AUTH
title: Understand JWT Tradeoffs
type: BUILD
difficulty: advanced
...
# AUTH-004 — Understand JWT Tradeoffs

## Objective

Complete a reviewable engineering exercise that demonstrates **understand jwt tradeoffs** and explain the decisions you made.

## Context

This is task 4 in the Authentication and Authorization phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind understand jwt tradeoffs.
...
1. Create or update the task artifact under `projects/full-stack/auth-004/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates understand jwt tradeoffs.
...
- Primary workspace: `projects/full-stack/auth-004/`
- Evidence: `projects/full-stack/auth-004/README.md`
...
- [ ] The artifact directly demonstrates understand jwt tradeoffs.
...
From the repository root, enter `projects/full-stack/auth-004` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[AUTH-004]`.
...
`task/<github-username>/auth-004-understand-jwt-tradeoffs`

## Commit Message

`build: complete auth-004 understand jwt tradeoffs`
