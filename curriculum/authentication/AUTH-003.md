...
id: AUTH-003
phase: AUTH
title: Login, Logout, Cookies, and Sessions
type: BUILD
difficulty: advanced
...
# AUTH-003 — Login, Logout, Cookies, and Sessions

## Objective

Complete a reviewable engineering exercise that demonstrates **login, logout, cookies, and sessions** and explain the decisions you made.

## Context

This is task 3 in the Authentication and Authorization phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind login, logout, cookies, and sessions.
...
1. Create or update the task artifact under `projects/full-stack/auth-003/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates login, logout, cookies, and sessions.
...
- Primary workspace: `projects/full-stack/auth-003/`
- Evidence: `projects/full-stack/auth-003/README.md`
...
- [ ] The artifact directly demonstrates login, logout, cookies, and sessions.
...
From the repository root, enter `projects/full-stack/auth-003` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[AUTH-003]`.
...
`build: complete auth-003 login, logout, cookies, and sessions`
