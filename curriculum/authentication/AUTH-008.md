...
id: AUTH-008
phase: AUTH
title: Audit and Harden an Authentication Feature
type: BUILD
difficulty: advanced
...
Complete a reviewable engineering exercise that demonstrates **audit and harden an authentication feature** and explain the decisions you made.

## Context

This is task 8 in the Authentication and Authorization phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind audit and harden an authentication feature.
...
1. Create or update the task artifact under `projects/full-stack/auth-008/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates audit and harden an authentication feature.
...
- Primary workspace: `projects/full-stack/auth-008/`
- Evidence: `projects/full-stack/auth-008/README.md`
...
- [ ] The artifact directly demonstrates audit and harden an authentication feature.
...
From the repository root, enter `projects/full-stack/auth-008` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[AUTH-008]`.
...
`build: complete auth-008 audit and harden an authentication feature`
