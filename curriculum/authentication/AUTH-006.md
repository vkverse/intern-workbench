...
id: AUTH-006
phase: AUTH
title: Model Roles and Permissions
type: BUILD
difficulty: advanced
...
# AUTH-006 — Model Roles and Permissions

## Objective

Complete a reviewable engineering exercise that demonstrates **model roles and permissions** and explain the decisions you made.

## Context

This is task 6 in the Authentication and Authorization phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind model roles and permissions.
...
1. Create or update the task artifact under `projects/full-stack/auth-006/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates model roles and permissions.
...
- Primary workspace: `projects/full-stack/auth-006/`
- Evidence: `projects/full-stack/auth-006/README.md`
...
- [ ] The artifact directly demonstrates model roles and permissions.
...
From the repository root, enter `projects/full-stack/auth-006` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[AUTH-006]`.
...
`build: complete auth-006 model roles and permissions`
