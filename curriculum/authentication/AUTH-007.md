...
id: AUTH-007
phase: AUTH
title: Validate and Test Authentication Flows
type: BUILD
difficulty: advanced
...
# AUTH-007 — Validate and Test Authentication Flows

## Objective

Complete a reviewable engineering exercise that demonstrates **validate and test authentication flows** and explain the decisions you made.

## Context

This is task 7 in the Authentication and Authorization phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind validate and test authentication flows.
...
1. Create or update the task artifact under `projects/full-stack/auth-007/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates validate and test authentication flows.
...
- Primary workspace: `projects/full-stack/auth-007/`
- Evidence: `projects/full-stack/auth-007/README.md`
...
- [ ] The artifact directly demonstrates validate and test authentication flows.
...
From the repository root, enter `projects/full-stack/auth-007` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[AUTH-007]`.
...
`build: complete auth-007 validate and test authentication flows`
