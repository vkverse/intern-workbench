...
id: NODE-002
phase: NODE
title: Environment and Filesystem Operations
type: BUILD
...
Complete a reviewable engineering exercise that demonstrates **environment and filesystem operations** and explain the decisions you made.

## Context

This is task 2 in the Node.js phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind environment and filesystem operations.
...
1. Create or update the task artifact under `projects/full-stack/api/node-002/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates environment and filesystem operations.
...
- Primary workspace: `projects/full-stack/api/node-002/`
- Evidence: `projects/full-stack/api/node-002/README.md`
...
- [ ] The artifact directly demonstrates environment and filesystem operations.
...
From the repository root, enter `projects/full-stack/api/node-002` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[NODE-002]`.
...
`build: complete node-002 environment and filesystem operations`
