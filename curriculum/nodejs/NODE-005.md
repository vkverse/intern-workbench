...
id: NODE-005
phase: NODE
title: Controllers, Services, and Separation of Concerns
type: BUILD
...
# NODE-005 — Controllers, Services, and Separation of Concerns

## Objective

Complete a reviewable engineering exercise that demonstrates **controllers, services, and separation of concerns** and explain the decisions you made.

## Context

This is task 5 in the Node.js phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind controllers, services, and separation of concerns.
...
1. Create or update the task artifact under `projects/full-stack/api/node-005/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates controllers, services, and separation of concerns.
...
- Primary workspace: `projects/full-stack/api/node-005/`
- Evidence: `projects/full-stack/api/node-005/README.md`
...
- [ ] The artifact directly demonstrates controllers, services, and separation of concerns.
...
From the repository root, enter `projects/full-stack/api/node-005` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[NODE-005]`.
...
`task/<github-username>/node-005-controllers-services-and-separation-of-con`

## Commit Message

`build: complete node-005 controllers, services, and separation of concerns`
