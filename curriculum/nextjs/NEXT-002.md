...
id: NEXT-002
phase: NEXT
title: App Router Pages, Layouts, and Navigation
type: BUILD
...
# NEXT-002 — App Router Pages, Layouts, and Navigation

## Objective

Complete a reviewable engineering exercise that demonstrates **app router pages, layouts, and navigation** and explain the decisions you made.

## Context

This is task 2 in the Next.js phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind app router pages, layouts, and navigation.
...
1. Create or update the task artifact under `projects/full-stack/web/next-002/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates app router pages, layouts, and navigation.
...
- Primary workspace: `projects/full-stack/web/next-002/`
- Evidence: `projects/full-stack/web/next-002/README.md`
...
- [ ] The artifact directly demonstrates app router pages, layouts, and navigation.
...
From the repository root, enter `projects/full-stack/web/next-002` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[NEXT-002]`.
...
`build: complete next-002 app router pages, layouts, and navigation`
