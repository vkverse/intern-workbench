...
id: NEXT-010
phase: NEXT
title: Build, Diagnose, and Prepare for Production
type: BUILD
...
# NEXT-010 — Build, Diagnose, and Prepare for Production

## Objective

Complete a reviewable engineering exercise that demonstrates **build, diagnose, and prepare for production** and explain the decisions you made.

## Context

This is task 10 in the Next.js phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind build, diagnose, and prepare for production.
...
1. Create or update the task artifact under `projects/full-stack/web/next-010/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates build, diagnose, and prepare for production.
...
- Primary workspace: `projects/full-stack/web/next-010/`
- Evidence: `projects/full-stack/web/next-010/README.md`
...
- [ ] The artifact directly demonstrates build, diagnose, and prepare for production.
...
From the repository root, enter `projects/full-stack/web/next-010` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[NEXT-010]`.
...
`build: complete next-010 build, diagnose, and prepare for production`
