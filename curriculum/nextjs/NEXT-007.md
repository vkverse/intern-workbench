...
id: NEXT-007
phase: NEXT
title: Server Actions and Validation
type: BUILD
...
Complete a reviewable engineering exercise that demonstrates **server actions and validation** and explain the decisions you made.

## Context

This is task 7 in the Next.js phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind server actions and validation.
...
1. Create or update the task artifact under `projects/full-stack/web/next-007/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates server actions and validation.
...
- Primary workspace: `projects/full-stack/web/next-007/`
- Evidence: `projects/full-stack/web/next-007/README.md`
...
- [ ] The artifact directly demonstrates server actions and validation.
...
From the repository root, enter `projects/full-stack/web/next-007` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[NEXT-007]`.
...
`build: complete next-007 server actions and validation`
