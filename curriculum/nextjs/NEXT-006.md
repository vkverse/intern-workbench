...
# NEXT-006 — Server and Client Component Boundaries

## Objective

Complete a reviewable engineering exercise that demonstrates **server and client component boundaries** and explain the decisions you made.

## Context

This is task 6 in the Next.js phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind server and client component boundaries.
...
1. Create or update the task artifact under `projects/full-stack/web/next-006/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates server and client component boundaries.
...
- Primary workspace: `projects/full-stack/web/next-006/`
- Evidence: `projects/full-stack/web/next-006/README.md`
...
- [ ] The artifact directly demonstrates server and client component boundaries.
...
From the repository root, enter `projects/full-stack/web/next-006` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[NEXT-006]`.
...
`task/<github-username>/next-006-server-and-client-component-boundaries`

## Commit Message

`build: complete next-006 server and client component boundaries`
