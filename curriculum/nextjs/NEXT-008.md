...
Complete a reviewable engineering exercise that demonstrates **data fetching and caching** and explain the decisions you made.

## Context

This is task 8 in the Next.js phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind data fetching and caching.
...
1. Create or update the task artifact under `projects/full-stack/web/next-008/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates data fetching and caching.
...
- Primary workspace: `projects/full-stack/web/next-008/`
- Evidence: `projects/full-stack/web/next-008/README.md`
...
- [ ] The artifact directly demonstrates data fetching and caching.
...
From the repository root, enter `projects/full-stack/web/next-008` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[NEXT-008]`.
...
`task/<github-username>/next-008-data-fetching-and-caching`

## Commit Message

`build: complete next-008 data fetching and caching`
