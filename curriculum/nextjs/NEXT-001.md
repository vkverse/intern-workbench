...
id: NEXT-001
phase: NEXT
title: Initialize a Current Next.js Project
type: BUILD
...
# NEXT-001 — Initialize a Current Next.js Project

## Objective

Complete a reviewable engineering exercise that demonstrates **initialize a current next.js project** and explain the decisions you made.

## Context

This is task 1 in the Next.js phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind initialize a current next.js project.
...
1. Create or update the task artifact under `projects/full-stack/web/next-001/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates initialize a current next.js project.
...
- Primary workspace: `projects/full-stack/web/next-001/`
- Evidence: `projects/full-stack/web/next-001/README.md`
...
- [ ] The artifact directly demonstrates initialize a current next.js project.
...
From the repository root, enter `projects/full-stack/web/next-001` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[NEXT-001]`.
...
`task/<github-username>/next-001-initialize-a-current-next-js-project`

## Commit Message

`build: complete next-001 initialize a current next.js project`
