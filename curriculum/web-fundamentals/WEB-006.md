...
id: WEB-006
phase: WEB
title: REST and JSON API Design
type: INVESTIGATE
...
# WEB-006 — REST and JSON API Design

## Objective

Complete a reviewable engineering exercise that demonstrates **rest and json api design** and explain the decisions you made.

## Context

This is task 6 in the Web Fundamentals phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind rest and json api design.
...
1. Create or update the task artifact under `evidence/web/web-006/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates rest and json api design.
...
- Primary workspace: `evidence/web/web-006/`
- Evidence: `evidence/web/web-006/README.md`
...
- [ ] The artifact directly demonstrates rest and json api design.
...
From the repository root, enter `evidence/web/web-006` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[WEB-006]`.
...
`task/<github-username>/web-006-rest-and-json-api-design`

## Commit Message

`investigate: complete web-006 rest and json api design`
