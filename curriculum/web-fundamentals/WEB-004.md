...
id: WEB-004
phase: WEB
title: Cookies, Sessions, and Browser Storage
type: INVESTIGATE
...
# WEB-004 — Cookies, Sessions, and Browser Storage

## Objective

Complete a reviewable engineering exercise that demonstrates **cookies, sessions, and browser storage** and explain the decisions you made.

## Context

This is task 4 in the Web Fundamentals phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind cookies, sessions, and browser storage.
...
1. Create or update the task artifact under `evidence/web/web-004/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates cookies, sessions, and browser storage.
...
- Primary workspace: `evidence/web/web-004/`
- Evidence: `evidence/web/web-004/README.md`
...
- [ ] The artifact directly demonstrates cookies, sessions, and browser storage.
...
From the repository root, enter `evidence/web/web-004` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[WEB-004]`.
...
`task/<github-username>/web-004-cookies-sessions-and-browser-storage`

## Commit Message

`investigate: complete web-004 cookies, sessions, and browser storage`
