...
# WEB-002 — Inspect HTTP Requests and Responses

## Objective

Complete a reviewable engineering exercise that demonstrates **inspect http requests and responses** and explain the decisions you made.

## Context

This is task 2 in the Web Fundamentals phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind inspect http requests and responses.
...
1. Create or update the task artifact under `evidence/web/web-002/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates inspect http requests and responses.
...
- Primary workspace: `evidence/web/web-002/`
- Evidence: `evidence/web/web-002/README.md`
...
- [ ] The artifact directly demonstrates inspect http requests and responses.
...
From the repository root, enter `evidence/web/web-002` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[WEB-002]`.
...
`task/<github-username>/web-002-inspect-http-requests-and-responses`

## Commit Message

`investigate: complete web-002 inspect http requests and responses`
