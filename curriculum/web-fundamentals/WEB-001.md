...
id: WEB-001
phase: WEB
title: Trace the Internet, DNS, and HTTPS
type: INVESTIGATE
...
# WEB-001 — Trace the Internet, DNS, and HTTPS

## Objective

Complete a reviewable engineering exercise that demonstrates **trace the internet, dns, and https** and explain the decisions you made.

## Context

This is task 1 in the Web Fundamentals phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind trace the internet, dns, and https.
...
1. Create or update the task artifact under `evidence/web/web-001/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates trace the internet, dns, and https.
...
- Primary workspace: `evidence/web/web-001/`
- Evidence: `evidence/web/web-001/README.md`
...
- [ ] The artifact directly demonstrates trace the internet, dns, and https.
...
From the repository root, enter `evidence/web/web-001` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[WEB-001]`.
...
`task/<github-username>/web-001-trace-the-internet-dns-and-https`

## Commit Message

`investigate: complete web-001 trace the internet, dns, and https`
