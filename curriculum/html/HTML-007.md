...
id: HTML-007
phase: HTML
title: Build a Product and Documentation Page
type: BUILD
difficulty: beginner
guidance: GUIDED
...
Complete a reviewable engineering exercise that demonstrates **build a product and documentation page** and explain the decisions you made.

## Context

This is task 7 in the HTML phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind build a product and documentation page.
...
1. Create or update the task artifact under `projects/beginner/site/html-007/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates build a product and documentation page.
...
- Primary workspace: `projects/beginner/site/html-007/`
- Evidence: `projects/beginner/site/html-007/README.md`
...
- [ ] The artifact directly demonstrates build a product and documentation page.
...
From the repository root, enter `projects/beginner/site/html-007` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[HTML-007]`.
...
`task/<github-username>/html-007-build-a-product-and-documentation-page`

## Commit Message

`build: complete html-007 build a product and documentation page`
