...
id: HTML-002
phase: HTML
title: Structure Text, Links, Images, and Lists
type: BUILD
difficulty: beginner
guidance: GUIDED
...
# HTML-002 — Structure Text, Links, Images, and Lists

## Objective

Complete a reviewable engineering exercise that demonstrates **structure text, links, images, and lists** and explain the decisions you made.

## Context

This is task 2 in the HTML phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind structure text, links, images, and lists.
...
1. Create or update the task artifact under `projects/beginner/site/html-002/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates structure text, links, images, and lists.
...
- Primary workspace: `projects/beginner/site/html-002/`
- Evidence: `projects/beginner/site/html-002/README.md`
...
Use semantic HTML and verify keyboard and screen-reader structure.
...
- [ ] The artifact directly demonstrates structure text, links, images, and lists.
...
From the repository root, enter `projects/beginner/site/html-002` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[HTML-002]`.
...
`task/<github-username>/html-002-structure-text-links-images-and-lists`

## Commit Message

`build: complete html-002 structure text, links, images, and lists`
