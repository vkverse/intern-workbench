...
id: HTML-005
phase: HTML
title: Add Metadata and SEO Fundamentals
type: BUILD
difficulty: beginner
guidance: GUIDED
...
# HTML-005 — Add Metadata and SEO Fundamentals

## Objective

Complete a reviewable engineering exercise that demonstrates **add metadata and seo fundamentals** and explain the decisions you made.

## Context

This is task 5 in the HTML phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind add metadata and seo fundamentals.
...
1. Create or update the task artifact under `projects/beginner/site/html-005/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates add metadata and seo fundamentals.
...
- Primary workspace: `projects/beginner/site/html-005/`
- Evidence: `projects/beginner/site/html-005/README.md`
...
- [ ] The artifact directly demonstrates add metadata and seo fundamentals.
...
From the repository root, enter `projects/beginner/site/html-005` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[HTML-005]`.
...
`task/<github-username>/html-005-add-metadata-and-seo-fundamentals`

## Commit Message

`build: complete html-005 add metadata and seo fundamentals`
