...
id: HTML-006
phase: HTML
title: Create Responsive Page Structure
type: BUILD
difficulty: beginner
guidance: GUIDED
...
Complete a reviewable engineering exercise that demonstrates **create responsive page structure** and explain the decisions you made.

## Context

This is task 6 in the HTML phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind create responsive page structure.
...
1. Create or update the task artifact under `projects/beginner/site/html-006/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates create responsive page structure.
...
- Primary workspace: `projects/beginner/site/html-006/`
- Evidence: `projects/beginner/site/html-006/README.md`
...
- [ ] The artifact directly demonstrates create responsive page structure.
...
From the repository root, enter `projects/beginner/site/html-006` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[HTML-006]`.
...
`task/<github-username>/html-006-create-responsive-page-structure`

## Commit Message

`build: complete html-006 create responsive page structure`
