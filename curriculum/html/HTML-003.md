...
# HTML-003 — Build Accessible Tables

## Objective

Complete a reviewable engineering exercise that demonstrates **build accessible tables** and explain the decisions you made.

## Context

This is task 3 in the HTML phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind build accessible tables.
...
1. Create or update the task artifact under `projects/beginner/site/html-003/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates build accessible tables.
...
- Primary workspace: `projects/beginner/site/html-003/`
- Evidence: `projects/beginner/site/html-003/README.md`
...
- [ ] The artifact directly demonstrates build accessible tables.
...
From the repository root, enter `projects/beginner/site/html-003` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[HTML-003]`.
...
`task/<github-username>/html-003-build-accessible-tables`

## Commit Message

`build: complete html-003 build accessible tables`
