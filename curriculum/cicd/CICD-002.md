...
# CICD-002 — Install Dependencies Reproducibly

## Objective

Complete a reviewable engineering exercise that demonstrates **install dependencies reproducibly** and explain the decisions you made.

## Context

This is task 2 in the CI/CD phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind install dependencies reproducibly.
...
1. Create or update the task artifact under `.github/workflows/cicd-002/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates install dependencies reproducibly.
...
- Primary workspace: `.github/workflows/cicd-002/`
- Evidence: `.github/workflows/cicd-002/README.md`
...
- [ ] The artifact directly demonstrates install dependencies reproducibly.
...
From the repository root, enter `.github/workflows/cicd-002` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[CICD-002]`.
...
`build: complete cicd-002 install dependencies reproducibly`
