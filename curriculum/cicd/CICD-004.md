...
id: CICD-004
phase: CICD
title: Automate Tests and Builds
type: BUILD
difficulty: advanced
...
Complete a reviewable engineering exercise that demonstrates **automate tests and builds** and explain the decisions you made.

## Context

This is task 4 in the CI/CD phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind automate tests and builds.
...
1. Create or update the task artifact under `.github/workflows/cicd-004/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates automate tests and builds.
...
- Primary workspace: `.github/workflows/cicd-004/`
- Evidence: `.github/workflows/cicd-004/README.md`
...
- [ ] The artifact directly demonstrates automate tests and builds.
...
From the repository root, enter `.github/workflows/cicd-004` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[CICD-004]`.
...
`task/<github-username>/cicd-004-automate-tests-and-builds`

## Commit Message

`build: complete cicd-004 automate tests and builds`
