...
id: CICD-007
phase: CICD
title: Build and Repair a Complete CI Pipeline
type: BUILD
difficulty: advanced
...
# CICD-007 — Build and Repair a Complete CI Pipeline

## Objective

Complete a reviewable engineering exercise that demonstrates **build and repair a complete ci pipeline** and explain the decisions you made.

## Context

This is task 7 in the CI/CD phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind build and repair a complete ci pipeline.
...
1. Create or update the task artifact under `.github/workflows/cicd-007/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates build and repair a complete ci pipeline.
...
- Primary workspace: `.github/workflows/cicd-007/`
- Evidence: `.github/workflows/cicd-007/README.md`
...
Automate objective checks only; human judgment remains with the mentor.
...
- [ ] The artifact directly demonstrates build and repair a complete ci pipeline.
...
From the repository root, enter `.github/workflows/cicd-007` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[CICD-007]`.
...
`task/<github-username>/cicd-007-build-and-repair-a-complete-ci-pipeline`

## Commit Message

`build: complete cicd-007 build and repair a complete ci pipeline`
