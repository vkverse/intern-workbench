...
id: QUALITY-002
phase: QUALITY
title: Separate Components and Responsibilities
type: REFACTOR
difficulty: advanced
...
# QUALITY-002 — Separate Components and Responsibilities

## Objective

Complete a reviewable engineering exercise that demonstrates **separate components and responsibilities** and explain the decisions you made.

## Context

This is task 2 in the Code Quality and Refactoring phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind separate components and responsibilities.
...
1. Create or update the task artifact under `projects/advanced/legacy-app/quality-002/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates separate components and responsibilities.
...
- Primary workspace: `projects/advanced/legacy-app/quality-002/`
- Evidence: `projects/advanced/legacy-app/quality-002/README.md`
...
- [ ] The artifact directly demonstrates separate components and responsibilities.
...
From the repository root, enter `projects/advanced/legacy-app/quality-002` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[QUALITY-002]`.
...
`refactor: complete quality-002 separate components and responsibilities`
