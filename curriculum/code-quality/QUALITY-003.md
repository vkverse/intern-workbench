...
id: QUALITY-003
phase: QUALITY
title: Apply DRY and KISS with Judgment
type: REFACTOR
difficulty: advanced
...
Complete a reviewable engineering exercise that demonstrates **apply dry and kiss with judgment** and explain the decisions you made.

## Context

This is task 3 in the Code Quality and Refactoring phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind apply dry and kiss with judgment.
...
1. Create or update the task artifact under `projects/advanced/legacy-app/quality-003/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates apply dry and kiss with judgment.
...
- Primary workspace: `projects/advanced/legacy-app/quality-003/`
- Evidence: `projects/advanced/legacy-app/quality-003/README.md`
...
- [ ] The artifact directly demonstrates apply dry and kiss with judgment.
...
From the repository root, enter `projects/advanced/legacy-app/quality-003` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[QUALITY-003]`.
...
`task/<github-username>/quality-003-apply-dry-and-kiss-with-judgment`

## Commit Message

`refactor: complete quality-003 apply dry and kiss with judgment`
