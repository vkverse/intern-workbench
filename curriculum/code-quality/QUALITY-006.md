...
id: QUALITY-006
phase: QUALITY
title: Improve Errors, Logging, and Configuration
type: REFACTOR
difficulty: advanced
...
Complete a reviewable engineering exercise that demonstrates **improve errors, logging, and configuration** and explain the decisions you made.

## Context

This is task 6 in the Code Quality and Refactoring phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind improve errors, logging, and configuration.
...
1. Create or update the task artifact under `projects/advanced/legacy-app/quality-006/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates improve errors, logging, and configuration.
...
- Primary workspace: `projects/advanced/legacy-app/quality-006/`
- Evidence: `projects/advanced/legacy-app/quality-006/README.md`
...
- [ ] The artifact directly demonstrates improve errors, logging, and configuration.
...
From the repository root, enter `projects/advanced/legacy-app/quality-006` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[QUALITY-006]`.
...
`task/<github-username>/quality-006-improve-errors-logging-and-configuration`

## Commit Message

`refactor: complete quality-006 improve errors, logging, and configuration`
