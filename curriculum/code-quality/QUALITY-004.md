...
id: QUALITY-004
phase: QUALITY
title: Recognize Code Smells and SOLID Boundaries
type: REFACTOR
difficulty: advanced
...
Complete a reviewable engineering exercise that demonstrates **recognize code smells and solid boundaries** and explain the decisions you made.

## Context

This is task 4 in the Code Quality and Refactoring phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind recognize code smells and solid boundaries.
...
1. Create or update the task artifact under `projects/advanced/legacy-app/quality-004/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates recognize code smells and solid boundaries.
...
- Primary workspace: `projects/advanced/legacy-app/quality-004/`
- Evidence: `projects/advanced/legacy-app/quality-004/README.md`
...
Preserve intended behavior and prove it with tests before and after refactoring.
...
- [ ] The artifact directly demonstrates recognize code smells and solid boundaries.
...
From the repository root, enter `projects/advanced/legacy-app/quality-004` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[QUALITY-004]`.
...
`task/<github-username>/quality-004-recognize-code-smells-and-solid-boundaries`

## Commit Message

`refactor: complete quality-004 recognize code smells and solid boundaries`
