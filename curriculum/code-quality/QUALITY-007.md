...
id: QUALITY-007
phase: QUALITY
title: Restructure a Maintainability Problem
type: REFACTOR
difficulty: advanced
...
# QUALITY-007 — Restructure a Maintainability Problem

## Objective

Complete a reviewable engineering exercise that demonstrates **restructure a maintainability problem** and explain the decisions you made.

## Context

This is task 7 in the Code Quality and Refactoring phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind restructure a maintainability problem.
...
1. Create or update the task artifact under `projects/advanced/legacy-app/quality-007/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates restructure a maintainability problem.
...
- Primary workspace: `projects/advanced/legacy-app/quality-007/`
- Evidence: `projects/advanced/legacy-app/quality-007/README.md`
...
- [ ] The artifact directly demonstrates restructure a maintainability problem.
...
From the repository root, enter `projects/advanced/legacy-app/quality-007` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[QUALITY-007]`.
...
`refactor: complete quality-007 restructure a maintainability problem`
