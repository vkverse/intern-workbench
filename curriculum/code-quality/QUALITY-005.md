...
# QUALITY-005 — Refactor Without Changing Behavior

## Objective

Complete a reviewable engineering exercise that demonstrates **refactor without changing behavior** and explain the decisions you made.

## Context

This is task 5 in the Code Quality and Refactoring phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind refactor without changing behavior.
...
1. Create or update the task artifact under `projects/advanced/legacy-app/quality-005/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates refactor without changing behavior.
...
- Primary workspace: `projects/advanced/legacy-app/quality-005/`
- Evidence: `projects/advanced/legacy-app/quality-005/README.md`
...
- [ ] The artifact directly demonstrates refactor without changing behavior.
...
From the repository root, enter `projects/advanced/legacy-app/quality-005` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[QUALITY-005]`.
...
`refactor: complete quality-005 refactor without changing behavior`
