...
id: TEST-007
phase: TEST
title: Test Authentication and Edge Cases
type: BUILD
...
# TEST-007 — Test Authentication and Edge Cases

## Objective

Complete a reviewable engineering exercise that demonstrates **test authentication and edge cases** and explain the decisions you made.

## Context

This is task 7 in the Testing phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind test authentication and edge cases.
...
1. Create or update the task artifact under `projects/intermediate/test-007/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates test authentication and edge cases.
...
- Primary workspace: `projects/intermediate/test-007/`
- Evidence: `projects/intermediate/test-007/README.md`
...
- [ ] The artifact directly demonstrates test authentication and edge cases.
...
From the repository root, enter `projects/intermediate/test-007` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[TEST-007]`.
...
`build: complete test-007 test authentication and edge cases`
