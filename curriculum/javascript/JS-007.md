...
id: JS-007
phase: JS
title: Events, Delegation, and Debouncing
type: BUILD
difficulty: beginner
...
# JS-007 — Events, Delegation, and Debouncing

## Objective

Complete a reviewable engineering exercise that demonstrates **events, delegation, and debouncing** and explain the decisions you made.

## Context

This is task 7 in the JavaScript phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind events, delegation, and debouncing.
...
1. Create or update the task artifact under `projects/intermediate/browser-app/js-007/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates events, delegation, and debouncing.
...
- Primary workspace: `projects/intermediate/browser-app/js-007/`
- Evidence: `projects/intermediate/browser-app/js-007/README.md`
...
- [ ] The artifact directly demonstrates events, delegation, and debouncing.
...
From the repository root, enter `projects/intermediate/browser-app/js-007` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[JS-007]`.
...
`task/<github-username>/js-007-events-delegation-and-debouncing`

## Commit Message

`build: complete js-007 events, delegation, and debouncing`
