...
id: JS-012
phase: JS
title: Debug and Repair a Broken Application
type: BUILD
difficulty: beginner
...
# JS-012 — Debug and Repair a Broken Application

## Objective

Complete a reviewable engineering exercise that demonstrates **debug and repair a broken application** and explain the decisions you made.

## Context

This is task 12 in the JavaScript phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind debug and repair a broken application.
...
1. Create or update the task artifact under `projects/intermediate/browser-app/js-012/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates debug and repair a broken application.
...
- Primary workspace: `projects/intermediate/browser-app/js-012/`
- Evidence: `projects/intermediate/browser-app/js-012/README.md`
...
- [ ] The artifact directly demonstrates debug and repair a broken application.
...
From the repository root, enter `projects/intermediate/browser-app/js-012` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[JS-012]`.
...
`task/<github-username>/js-012-debug-and-repair-a-broken-application`

## Commit Message

`build: complete js-012 debug and repair a broken application`
