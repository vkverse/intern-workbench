...
# JS-003 — Arrays, Objects, and Destructuring

## Objective

Complete a reviewable engineering exercise that demonstrates **arrays, objects, and destructuring** and explain the decisions you made.

## Context

This is task 3 in the JavaScript phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind arrays, objects, and destructuring.
...
1. Create or update the task artifact under `projects/intermediate/browser-app/js-003/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates arrays, objects, and destructuring.
...
- Primary workspace: `projects/intermediate/browser-app/js-003/`
- Evidence: `projects/intermediate/browser-app/js-003/README.md`
...
- [ ] The artifact directly demonstrates arrays, objects, and destructuring.
...
From the repository root, enter `projects/intermediate/browser-app/js-003` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[JS-003]`.
...
`task/<github-username>/js-003-arrays-objects-and-destructuring`

## Commit Message

`build: complete js-003 arrays, objects, and destructuring`
