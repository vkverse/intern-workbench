...
id: JS-001
phase: JS
title: Variables, Data Types, Operators, and Conditionals
type: BUILD
difficulty: beginner
...
# JS-001 — Variables, Data Types, Operators, and Conditionals

## Objective

Complete a reviewable engineering exercise that demonstrates **variables, data types, operators, and conditionals** and explain the decisions you made.

## Context

This is task 1 in the JavaScript phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind variables, data types, operators, and conditionals.
...
1. Create or update the task artifact under `projects/intermediate/browser-app/js-001/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates variables, data types, operators, and conditionals.
...
- Primary workspace: `projects/intermediate/browser-app/js-001/`
- Evidence: `projects/intermediate/browser-app/js-001/README.md`
...
Keep behavior observable and handle invalid input explicitly.
...
- [ ] The artifact directly demonstrates variables, data types, operators, and conditionals.
...
From the repository root, enter `projects/intermediate/browser-app/js-001` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[JS-001]`.
...
`task/<github-username>/js-001-variables-data-types-operators-and-conditi`

## Commit Message

`build: complete js-001 variables, data types, operators, and conditionals`
