...
id: JS-011
phase: JS
title: Build an API-Powered Application
type: BUILD
difficulty: beginner
...
# JS-011 — Build an API-Powered Application

## Objective

Complete a reviewable engineering exercise that demonstrates **build an api-powered application** and explain the decisions you made.

## Context

This is task 11 in the JavaScript phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind build an api-powered application.
...
1. Create or update the task artifact under `projects/intermediate/browser-app/js-011/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates build an api-powered application.
...
- Primary workspace: `projects/intermediate/browser-app/js-011/`
- Evidence: `projects/intermediate/browser-app/js-011/README.md`
...
- [ ] The artifact directly demonstrates build an api-powered application.
...
From the repository root, enter `projects/intermediate/browser-app/js-011` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[JS-011]`.
...
`task/<github-username>/js-011-build-an-api-powered-application`

## Commit Message

`build: complete js-011 build an api-powered application`
