...
id: JS-002
phase: JS
title: Loops, Functions, and Scope
type: BUILD
difficulty: beginner
...
# JS-002 — Loops, Functions, and Scope

## Objective

Complete a reviewable engineering exercise that demonstrates **loops, functions, and scope** and explain the decisions you made.

## Context

This is task 2 in the JavaScript phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind loops, functions, and scope.
...
1. Create or update the task artifact under `projects/intermediate/browser-app/js-002/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates loops, functions, and scope.
...
- Primary workspace: `projects/intermediate/browser-app/js-002/`
- Evidence: `projects/intermediate/browser-app/js-002/README.md`
...
- [ ] The artifact directly demonstrates loops, functions, and scope.
...
From the repository root, enter `projects/intermediate/browser-app/js-002` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[JS-002]`.
...
`task/<github-username>/js-002-loops-functions-and-scope`

## Commit Message

`build: complete js-002 loops, functions, and scope`
