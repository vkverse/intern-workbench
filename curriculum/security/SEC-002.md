...
id: SEC-002
phase: SEC
title: Find and Fix Cross-Site Scripting
type: INVESTIGATE
difficulty: advanced
...
# SEC-002 — Find and Fix Cross-Site Scripting

## Objective

Complete a reviewable engineering exercise that demonstrates **find and fix cross-site scripting** and explain the decisions you made.

## Context

This is task 2 in the Security phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind find and fix cross-site scripting.
...
1. Create or update the task artifact under `projects/advanced/security-lab/sec-002/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates find and fix cross-site scripting.
...
- Primary workspace: `projects/advanced/security-lab/sec-002/`
- Evidence: `projects/advanced/security-lab/sec-002/README.md`
...
- [ ] The artifact directly demonstrates find and fix cross-site scripting.
...
From the repository root, enter `projects/advanced/security-lab/sec-002` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[SEC-002]`.
...
`task/<github-username>/sec-002-find-and-fix-cross-site-scripting`

## Commit Message

`investigate: complete sec-002 find and fix cross-site scripting`
