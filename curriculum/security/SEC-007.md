...
id: SEC-007
phase: SEC
title: Validate Inputs and Secure API Boundaries
type: INVESTIGATE
difficulty: advanced
...
# SEC-007 — Validate Inputs and Secure API Boundaries

## Objective

Complete a reviewable engineering exercise that demonstrates **validate inputs and secure api boundaries** and explain the decisions you made.

## Context

This is task 7 in the Security phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind validate inputs and secure api boundaries.
...
1. Create or update the task artifact under `projects/advanced/security-lab/sec-007/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates validate inputs and secure api boundaries.
...
- Primary workspace: `projects/advanced/security-lab/sec-007/`
- Evidence: `projects/advanced/security-lab/sec-007/README.md`
...
- [ ] The artifact directly demonstrates validate inputs and secure api boundaries.
...
From the repository root, enter `projects/advanced/security-lab/sec-007` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[SEC-007]`.
...
`task/<github-username>/sec-007-validate-inputs-and-secure-api-boundaries`

## Commit Message

`investigate: complete sec-007 validate inputs and secure api boundaries`
