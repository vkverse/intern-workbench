...
id: SEC-008
phase: SEC
title: Review, Repair, and Regression-Test a Vulnerable App
type: INVESTIGATE
difficulty: advanced
...
# SEC-008 — Review, Repair, and Regression-Test a Vulnerable App

## Objective

Complete a reviewable engineering exercise that demonstrates **review, repair, and regression-test a vulnerable app** and explain the decisions you made.

## Context

This is task 8 in the Security phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind review, repair, and regression-test a vulnerable app.
...
1. Create or update the task artifact under `projects/advanced/security-lab/sec-008/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates review, repair, and regression-test a vulnerable app.
...
- Primary workspace: `projects/advanced/security-lab/sec-008/`
- Evidence: `projects/advanced/security-lab/sec-008/README.md`
...
- [ ] The artifact directly demonstrates review, repair, and regression-test a vulnerable app.
...
From the repository root, enter `projects/advanced/security-lab/sec-008` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[SEC-008]`.
...
`task/<github-username>/sec-008-review-repair-and-regression-test-a-vulner`

## Commit Message

`investigate: complete sec-008 review, repair, and regression-test a vulnerable app`
