...
id: SEC-001
phase: SEC
title: Adopt a Practical Security Mindset
type: INVESTIGATE
difficulty: advanced
...
# SEC-001 — Adopt a Practical Security Mindset

## Objective

Complete a reviewable engineering exercise that demonstrates **adopt a practical security mindset** and explain the decisions you made.

## Context

This is task 1 in the Security phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind adopt a practical security mindset.
...
1. Create or update the task artifact under `projects/advanced/security-lab/sec-001/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates adopt a practical security mindset.
...
- Primary workspace: `projects/advanced/security-lab/sec-001/`
- Evidence: `projects/advanced/security-lab/sec-001/README.md`
...
- [ ] The artifact directly demonstrates adopt a practical security mindset.
...
From the repository root, enter `projects/advanced/security-lab/sec-001` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[SEC-001]`.
...
`task/<github-username>/sec-001-adopt-a-practical-security-mindset`

## Commit Message

`investigate: complete sec-001 adopt a practical security mindset`
