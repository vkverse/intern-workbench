...
# SEC-005 — Audit Authentication and Authorization

## Objective

Complete a reviewable engineering exercise that demonstrates **audit authentication and authorization** and explain the decisions you made.

## Context

This is task 5 in the Security phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind audit authentication and authorization.
...
1. Create or update the task artifact under `projects/advanced/security-lab/sec-005/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates audit authentication and authorization.
...
- Primary workspace: `projects/advanced/security-lab/sec-005/`
- Evidence: `projects/advanced/security-lab/sec-005/README.md`
...
- [ ] The artifact directly demonstrates audit authentication and authorization.
...
From the repository root, enter `projects/advanced/security-lab/sec-005` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[SEC-005]`.
...
`task/<github-username>/sec-005-audit-authentication-and-authorization`

## Commit Message

`investigate: complete sec-005 audit authentication and authorization`
