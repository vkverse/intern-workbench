...
id: SYSTEM-006
phase: SYSTEM
title: Review a Production Architecture
type: DESIGN
difficulty: advanced
guidance: AMBIGUOUS
...
# SYSTEM-006 — Review a Production Architecture

## Objective

Complete a reviewable engineering exercise that demonstrates **review a production architecture** and explain the decisions you made.

## Context

This is task 6 in the System Design phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind review a production architecture.
...
1. Create or update the task artifact under `design/system/system-006/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates review a production architecture.
...
- Primary workspace: `design/system/system-006/`
- Evidence: `design/system/system-006/README.md`
...
- [ ] The artifact directly demonstrates review a production architecture.
...
From the repository root, enter `design/system/system-006` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[SYSTEM-006]`.
...
`design: complete system-006 review a production architecture`
