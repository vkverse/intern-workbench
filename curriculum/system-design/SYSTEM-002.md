...
id: SYSTEM-002
phase: SYSTEM
title: Choose Vertical, Horizontal, and Load-Balancing Strategies
type: DESIGN
difficulty: advanced
guidance: AMBIGUOUS
...
# SYSTEM-002 — Choose Vertical, Horizontal, and Load-Balancing Strategies

## Objective

Complete a reviewable engineering exercise that demonstrates **choose vertical, horizontal, and load-balancing strategies** and explain the decisions you made.

## Context

This is task 2 in the System Design phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind choose vertical, horizontal, and load-balancing strategies.
...
1. Create or update the task artifact under `design/system/system-002/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates choose vertical, horizontal, and load-balancing strategies.
...
- Primary workspace: `design/system/system-002/`
- Evidence: `design/system/system-002/README.md`
...
Tie every component to a requirement, failure mode, or operational need.
...
- [ ] The artifact directly demonstrates choose vertical, horizontal, and load-balancing strategies.
...
From the repository root, enter `design/system/system-002` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[SYSTEM-002]`.
...
`design: complete system-002 choose vertical, horizontal, and load-balancing strategies`
