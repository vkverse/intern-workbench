...
id: SYSTEM-003
phase: SYSTEM
title: Design Caching, Queues, and Stateless Work
type: DESIGN
difficulty: advanced
guidance: AMBIGUOUS
...
Complete a reviewable engineering exercise that demonstrates **design caching, queues, and stateless work** and explain the decisions you made.

## Context

This is task 3 in the System Design phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind design caching, queues, and stateless work.
...
1. Create or update the task artifact under `design/system/system-003/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates design caching, queues, and stateless work.
...
- Primary workspace: `design/system/system-003/`
- Evidence: `design/system/system-003/README.md`
...
- [ ] The artifact directly demonstrates design caching, queues, and stateless work.
...
From the repository root, enter `design/system/system-003` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[SYSTEM-003]`.
...
`design: complete system-003 design caching, queues, and stateless work`
