...
id: SYSTEM-005
phase: SYSTEM
title: Design File Delivery, CDN, Reliability, and Monitoring
type: DESIGN
difficulty: advanced
guidance: AMBIGUOUS
...
# SYSTEM-005 — Design File Delivery, CDN, Reliability, and Monitoring

## Objective

Complete a reviewable engineering exercise that demonstrates **design file delivery, cdn, reliability, and monitoring** and explain the decisions you made.

## Context

This is task 5 in the System Design phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind design file delivery, cdn, reliability, and monitoring.
...
1. Create or update the task artifact under `design/system/system-005/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates design file delivery, cdn, reliability, and monitoring.
...
- Primary workspace: `design/system/system-005/`
- Evidence: `design/system/system-005/README.md`
...
- [ ] The artifact directly demonstrates design file delivery, cdn, reliability, and monitoring.
...
From the repository root, enter `design/system/system-005` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[SYSTEM-005]`.
...
`design: complete system-005 design file delivery, cdn, reliability, and monitoring`
