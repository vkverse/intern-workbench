...
id: TS-002
phase: TS
title: Interfaces, Aliases, and Object Shapes
type: REFACTOR
...
# TS-002 — Interfaces, Aliases, and Object Shapes

## Objective

Complete a reviewable engineering exercise that demonstrates **interfaces, aliases, and object shapes** and explain the decisions you made.

## Context

This is task 2 in the TypeScript phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind interfaces, aliases, and object shapes.
...
1. Create or update the task artifact under `projects/intermediate/typed-app/ts-002/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates interfaces, aliases, and object shapes.
...
- Primary workspace: `projects/intermediate/typed-app/ts-002/`
- Evidence: `projects/intermediate/typed-app/ts-002/README.md`
...
- [ ] The artifact directly demonstrates interfaces, aliases, and object shapes.
...
From the repository root, enter `projects/intermediate/typed-app/ts-002` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[TS-002]`.
...
`task/<github-username>/ts-002-interfaces-aliases-and-object-shapes`

## Commit Message

`refactor: complete ts-002 interfaces, aliases, and object shapes`
