...
# TS-005 — Generics and Utility Types

## Objective

Complete a reviewable engineering exercise that demonstrates **generics and utility types** and explain the decisions you made.

## Context

This is task 5 in the TypeScript phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind generics and utility types.
...
1. Create or update the task artifact under `projects/intermediate/typed-app/ts-005/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates generics and utility types.
...
- Primary workspace: `projects/intermediate/typed-app/ts-005/`
- Evidence: `projects/intermediate/typed-app/ts-005/README.md`
...
- [ ] The artifact directly demonstrates generics and utility types.
...
From the repository root, enter `projects/intermediate/typed-app/ts-005` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[TS-005]`.
...
`task/<github-username>/ts-005-generics-and-utility-types`

## Commit Message

`refactor: complete ts-005 generics and utility types`
