...
id: TS-003
phase: TS
title: Unions, Literals, and Optional Properties
type: REFACTOR
...
# TS-003 — Unions, Literals, and Optional Properties

## Objective

Complete a reviewable engineering exercise that demonstrates **unions, literals, and optional properties** and explain the decisions you made.

## Context

This is task 3 in the TypeScript phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind unions, literals, and optional properties.
...
1. Create or update the task artifact under `projects/intermediate/typed-app/ts-003/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates unions, literals, and optional properties.
...
- Primary workspace: `projects/intermediate/typed-app/ts-003/`
- Evidence: `projects/intermediate/typed-app/ts-003/README.md`
...
- [ ] The artifact directly demonstrates unions, literals, and optional properties.
...
From the repository root, enter `projects/intermediate/typed-app/ts-003` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[TS-003]`.
...
`task/<github-username>/ts-003-unions-literals-and-optional-properties`

## Commit Message

`refactor: complete ts-003 unions, literals, and optional properties`
