...
id: TS-004
phase: TS
title: Typed Functions and Collections
type: REFACTOR
...
# TS-004 — Typed Functions and Collections

## Objective

Complete a reviewable engineering exercise that demonstrates **typed functions and collections** and explain the decisions you made.

## Context

This is task 4 in the TypeScript phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind typed functions and collections.
...
1. Create or update the task artifact under `projects/intermediate/typed-app/ts-004/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates typed functions and collections.
...
- Primary workspace: `projects/intermediate/typed-app/ts-004/`
- Evidence: `projects/intermediate/typed-app/ts-004/README.md`
...
- [ ] The artifact directly demonstrates typed functions and collections.
...
From the repository root, enter `projects/intermediate/typed-app/ts-004` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[TS-004]`.
...
`task/<github-username>/ts-004-typed-functions-and-collections`

## Commit Message

`refactor: complete ts-004 typed functions and collections`
