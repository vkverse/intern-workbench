...
id: DOCS-005
phase: DOCS
title: Record Decisions and Changes
type: DOCUMENT
...
Complete a reviewable engineering exercise that demonstrates **record decisions and changes** and explain the decisions you made.

## Context

This is task 5 in the Documentation phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind record decisions and changes.
...
1. Create or update the task artifact under `docs/practice/docs-005/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates record decisions and changes.
...
- Primary workspace: `docs/practice/docs-005/`
- Evidence: `docs/practice/docs-005/README.md`
...
- [ ] The artifact directly demonstrates record decisions and changes.
...
From the repository root, enter `docs/practice/docs-005` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[DOCS-005]`.
...
`document: complete docs-005 record decisions and changes`
