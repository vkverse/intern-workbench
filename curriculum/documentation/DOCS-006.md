...
id: DOCS-006
phase: DOCS
title: Audit and Improve Existing Documentation
type: DOCUMENT
...
# DOCS-006 — Audit and Improve Existing Documentation

## Objective

Complete a reviewable engineering exercise that demonstrates **audit and improve existing documentation** and explain the decisions you made.

## Context

This is task 6 in the Documentation phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind audit and improve existing documentation.
...
1. Create or update the task artifact under `docs/practice/docs-006/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates audit and improve existing documentation.
...
- Primary workspace: `docs/practice/docs-006/`
- Evidence: `docs/practice/docs-006/README.md`
...
- [ ] The artifact directly demonstrates audit and improve existing documentation.
...
From the repository root, enter `docs/practice/docs-006` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[DOCS-006]`.
...
`task/<github-username>/docs-006-audit-and-improve-existing-documentation`

## Commit Message

`document: complete docs-006 audit and improve existing documentation`
