...
id: DOCS-004
phase: DOCS
title: Write Troubleshooting Guidance
type: DOCUMENT
...
# DOCS-004 — Write Troubleshooting Guidance

## Objective

Complete a reviewable engineering exercise that demonstrates **write troubleshooting guidance** and explain the decisions you made.

## Context

This is task 4 in the Documentation phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind write troubleshooting guidance.
...
1. Create or update the task artifact under `docs/practice/docs-004/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates write troubleshooting guidance.
...
- Primary workspace: `docs/practice/docs-004/`
- Evidence: `docs/practice/docs-004/README.md`
...
- [ ] The artifact directly demonstrates write troubleshooting guidance.
...
From the repository root, enter `docs/practice/docs-004` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[DOCS-004]`.
...
`task/<github-username>/docs-004-write-troubleshooting-guidance`

## Commit Message

`document: complete docs-004 write troubleshooting guidance`
