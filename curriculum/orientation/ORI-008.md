...
id: ORI-008
phase: ORI
title: Development, Production, and Debugging Mindset
type: LEARN
difficulty: beginner
guidance: GUIDED
...
# ORI-008 — Development, Production, and Debugging Mindset

## Objective

Complete a reviewable engineering exercise that demonstrates **development, production, and debugging mindset** and explain the decisions you made.

## Context

This is task 8 in the Orientation phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind development, production, and debugging mindset.
...
1. Create or update the task artifact under `notes/orientation.md/ori-008/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates development, production, and debugging mindset.
...
- Primary workspace: `notes/orientation.md/ori-008/`
- Evidence: `notes/orientation.md/ori-008/README.md`
...
- [ ] The artifact directly demonstrates development, production, and debugging mindset.
...
From the repository root, enter `notes/orientation.md/ori-008` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[ORI-008]`.
...
`task/<github-username>/ori-008-development-production-and-debugging-minds`

## Commit Message

`learn: complete ori-008 development, production, and debugging mindset`
