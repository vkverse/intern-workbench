...
id: ORI-003
phase: ORI
title: Browser, Files, and Folders
type: LEARN
difficulty: beginner
guidance: GUIDED
...
# ORI-003 — Browser, Files, and Folders

## Objective

Complete a reviewable engineering exercise that demonstrates **browser, files, and folders** and explain the decisions you made.

## Context

This is task 3 in the Orientation phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind browser, files, and folders.
...
1. Create or update the task artifact under `notes/orientation.md/ori-003/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates browser, files, and folders.
...
- Primary workspace: `notes/orientation.md/ori-003/`
- Evidence: `notes/orientation.md/ori-003/README.md`
...
- [ ] The artifact directly demonstrates browser, files, and folders.
...
From the repository root, enter `notes/orientation.md/ori-003` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[ORI-003]`.
...
`task/<github-username>/ori-003-browser-files-and-folders`

## Commit Message

`learn: complete ori-003 browser, files, and folders`
