...
id: ORI-005
phase: ORI
title: Development Commands and Package Managers
type: LEARN
difficulty: beginner
guidance: GUIDED
...
# ORI-005 — Development Commands and Package Managers

## Objective

Complete a reviewable engineering exercise that demonstrates **development commands and package managers** and explain the decisions you made.

## Context

This is task 5 in the Orientation phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind development commands and package managers.
...
1. Create or update the task artifact under `notes/orientation.md/ori-005/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates development commands and package managers.
...
- Primary workspace: `notes/orientation.md/ori-005/`
- Evidence: `notes/orientation.md/ori-005/README.md`
...
- [ ] The artifact directly demonstrates development commands and package managers.
...
From the repository root, enter `notes/orientation.md/ori-005` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[ORI-005]`.
...
`task/<github-username>/ori-005-development-commands-and-package-managers`

## Commit Message

`learn: complete ori-005 development commands and package managers`
