...
id: ORI-004
phase: ORI
title: Terminal Navigation and File Operations
type: LEARN
difficulty: beginner
guidance: GUIDED
...
# ORI-004 — Terminal Navigation and File Operations

## Objective

Complete a reviewable engineering exercise that demonstrates **terminal navigation and file operations** and explain the decisions you made.

## Context

This is task 4 in the Orientation phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind terminal navigation and file operations.
...
1. Create or update the task artifact under `notes/orientation.md/ori-004/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates terminal navigation and file operations.
...
- Primary workspace: `notes/orientation.md/ori-004/`
- Evidence: `notes/orientation.md/ori-004/README.md`
...
- [ ] The artifact directly demonstrates terminal navigation and file operations.
...
From the repository root, enter `notes/orientation.md/ori-004` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[ORI-004]`.
...
`task/<github-username>/ori-004-terminal-navigation-and-file-operations`

## Commit Message

`learn: complete ori-004 terminal navigation and file operations`
