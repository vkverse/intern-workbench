...
id: REAL-005
phase: REAL
title: Refactor an Unfamiliar Legacy Feature
type: INVESTIGATE
difficulty: advanced
guidance: AMBIGUOUS
...
Complete a reviewable engineering exercise that demonstrates **refactor an unfamiliar legacy feature** and explain the decisions you made.

## Context

This is task 5 in the Real Engineering phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind refactor an unfamiliar legacy feature.
...
1. Create or update the task artifact under `projects/advanced/product-app/real-005/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates refactor an unfamiliar legacy feature.
...
- Primary workspace: `projects/advanced/product-app/real-005/`
- Evidence: `projects/advanced/product-app/real-005/README.md`
...
- [ ] The artifact directly demonstrates refactor an unfamiliar legacy feature.
...
From the repository root, enter `projects/advanced/product-app/real-005` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[REAL-005]`.
...
`task/<github-username>/real-005-refactor-an-unfamiliar-legacy-feature`

## Commit Message

`investigate: complete real-005 refactor an unfamiliar legacy feature`
