...
id: REAL-002
phase: REAL
title: Diagnose an Unknown Product Bug
type: INVESTIGATE
difficulty: advanced
guidance: AMBIGUOUS
...
# REAL-002 — Diagnose an Unknown Product Bug

## Objective

Complete a reviewable engineering exercise that demonstrates **diagnose an unknown product bug** and explain the decisions you made.

## Context

This is task 2 in the Real Engineering phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind diagnose an unknown product bug.
...
1. Create or update the task artifact under `projects/advanced/product-app/real-002/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates diagnose an unknown product bug.
...
- Primary workspace: `projects/advanced/product-app/real-002/`
- Evidence: `projects/advanced/product-app/real-002/README.md`
...
- [ ] The artifact directly demonstrates diagnose an unknown product bug.
...
From the repository root, enter `projects/advanced/product-app/real-002` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[REAL-002]`.
...
`task/<github-username>/real-002-diagnose-an-unknown-product-bug`

## Commit Message

`investigate: complete real-002 diagnose an unknown product bug`
