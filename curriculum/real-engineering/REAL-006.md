...
id: REAL-006
phase: REAL
title: Find and Close Testing and Security Gaps
type: INVESTIGATE
difficulty: advanced
guidance: AMBIGUOUS
...
# REAL-006 — Find and Close Testing and Security Gaps

## Objective

Complete a reviewable engineering exercise that demonstrates **find and close testing and security gaps** and explain the decisions you made.

## Context

This is task 6 in the Real Engineering phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind find and close testing and security gaps.
...
1. Create or update the task artifact under `projects/advanced/product-app/real-006/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates find and close testing and security gaps.
...
- Primary workspace: `projects/advanced/product-app/real-006/`
- Evidence: `projects/advanced/product-app/real-006/README.md`
...
- [ ] The artifact directly demonstrates find and close testing and security gaps.
...
From the repository root, enter `projects/advanced/product-app/real-006` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[REAL-006]`.
...
`investigate: complete real-006 find and close testing and security gaps`
