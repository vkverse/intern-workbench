...
id: REAL-007
phase: REAL
title: Handle a Production-Like Incident
type: INVESTIGATE
difficulty: advanced
guidance: AMBIGUOUS
...
Complete a reviewable engineering exercise that demonstrates **handle a production-like incident** and explain the decisions you made.

## Context

This is task 7 in the Real Engineering phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind handle a production-like incident.
...
1. Create or update the task artifact under `projects/advanced/product-app/real-007/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates handle a production-like incident.
...
- Primary workspace: `projects/advanced/product-app/real-007/`
- Evidence: `projects/advanced/product-app/real-007/README.md`
...
- [ ] The artifact directly demonstrates handle a production-like incident.
...
From the repository root, enter `projects/advanced/product-app/real-007` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[REAL-007]`.
...
`investigate: complete real-007 handle a production-like incident`
