...
id: REAL-008
phase: REAL
title: Propose, Defend, and Implement a Technical Solution
type: INVESTIGATE
difficulty: advanced
guidance: AMBIGUOUS
...
Complete a reviewable engineering exercise that demonstrates **propose, defend, and implement a technical solution** and explain the decisions you made.

## Context

This is task 8 in the Real Engineering phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind propose, defend, and implement a technical solution.
...
1. Create or update the task artifact under `projects/advanced/product-app/real-008/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates propose, defend, and implement a technical solution.
...
- Primary workspace: `projects/advanced/product-app/real-008/`
- Evidence: `projects/advanced/product-app/real-008/README.md`
...
- [ ] The artifact directly demonstrates propose, defend, and implement a technical solution.
...
From the repository root, enter `projects/advanced/product-app/real-008` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[REAL-008]`.
...
`investigate: complete real-008 propose, defend, and implement a technical solution`
