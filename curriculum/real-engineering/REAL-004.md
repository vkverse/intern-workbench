...
id: REAL-004
phase: REAL
title: Add a Feature Without Regressions
type: INVESTIGATE
difficulty: advanced
guidance: AMBIGUOUS
...
# REAL-004 — Add a Feature Without Regressions

## Objective

Complete a reviewable engineering exercise that demonstrates **add a feature without regressions** and explain the decisions you made.

## Context

This is task 4 in the Real Engineering phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind add a feature without regressions.
...
1. Create or update the task artifact under `projects/advanced/product-app/real-004/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates add a feature without regressions.
...
- Primary workspace: `projects/advanced/product-app/real-004/`
- Evidence: `projects/advanced/product-app/real-004/README.md`
...
- [ ] The artifact directly demonstrates add a feature without regressions.
...
From the repository root, enter `projects/advanced/product-app/real-004` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[REAL-004]`.
...
`investigate: complete real-004 add a feature without regressions`
