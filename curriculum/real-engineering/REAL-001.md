...
id: REAL-001
phase: REAL
title: Investigate a Slow Dashboard
type: INVESTIGATE
difficulty: advanced
guidance: AMBIGUOUS
...
Complete a reviewable engineering exercise that demonstrates **investigate a slow dashboard** and explain the decisions you made.

## Context

This is task 1 in the Real Engineering phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind investigate a slow dashboard.
...
1. Create or update the task artifact under `projects/advanced/product-app/real-001/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates investigate a slow dashboard.
...
- Primary workspace: `projects/advanced/product-app/real-001/`
- Evidence: `projects/advanced/product-app/real-001/README.md`
...
- [ ] The artifact directly demonstrates investigate a slow dashboard.
...
From the repository root, enter `projects/advanced/product-app/real-001` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[REAL-001]`.
...
`task/<github-username>/real-001-investigate-a-slow-dashboard`

## Commit Message

`investigate: complete real-001 investigate a slow dashboard`
