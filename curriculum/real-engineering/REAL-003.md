...
id: REAL-003
phase: REAL
title: Convert a Product Requirement into a Technical Plan
type: INVESTIGATE
difficulty: advanced
guidance: AMBIGUOUS
...
Complete a reviewable engineering exercise that demonstrates **convert a product requirement into a technical plan** and explain the decisions you made.

## Context

This is task 3 in the Real Engineering phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind convert a product requirement into a technical plan.
...
1. Create or update the task artifact under `projects/advanced/product-app/real-003/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates convert a product requirement into a technical plan.
...
- Primary workspace: `projects/advanced/product-app/real-003/`
- Evidence: `projects/advanced/product-app/real-003/README.md`
...
Clarify uncertainty, limit scope, and explain tradeoffs before implementation.
...
- [ ] The artifact directly demonstrates convert a product requirement into a technical plan.
...
From the repository root, enter `projects/advanced/product-app/real-003` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[REAL-003]`.
...
`investigate: complete real-003 convert a product requirement into a technical plan`
