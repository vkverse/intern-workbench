...
id: FINAL-002
phase: FINAL
title: Create Milestones, Issues, and an Architecture Plan
type: PROJECT
difficulty: advanced
guidance: AMBIGUOUS
...
# FINAL-002 — Create Milestones, Issues, and an Architecture Plan

## Objective

Complete a reviewable engineering exercise that demonstrates **create milestones, issues, and an architecture plan** and explain the decisions you made.

## Context

This is task 2 in the Final Project phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind create milestones, issues, and an architecture plan.
...
1. Create or update the task artifact under `projects/final/final-002/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates create milestones, issues, and an architecture plan.
...
- Primary workspace: `projects/final/final-002/`
- Evidence: `projects/final/final-002/README.md`
...
- [ ] The artifact directly demonstrates create milestones, issues, and an architecture plan.
...
From the repository root, enter `projects/final/final-002` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[FINAL-002]`.
...
`project: complete final-002 create milestones, issues, and an architecture plan`
