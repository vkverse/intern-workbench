...
id: FINAL-003
phase: FINAL
title: Design the Database, API, UI, and Test Strategy
type: PROJECT
difficulty: advanced
guidance: AMBIGUOUS
...
# FINAL-003 — Design the Database, API, UI, and Test Strategy

## Objective

Complete a reviewable engineering exercise that demonstrates **design the database, api, ui, and test strategy** and explain the decisions you made.

## Context

This is task 3 in the Final Project phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind design the database, api, ui, and test strategy.
...
1. Create or update the task artifact under `projects/final/final-003/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates design the database, api, ui, and test strategy.
...
- Primary workspace: `projects/final/final-003/`
- Evidence: `projects/final/final-003/README.md`
...
- [ ] The artifact directly demonstrates design the database, api, ui, and test strategy.
...
From the repository root, enter `projects/final/final-003` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[FINAL-003]`.
...
`project: complete final-003 design the database, api, ui, and test strategy`
