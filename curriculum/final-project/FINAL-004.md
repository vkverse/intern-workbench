...
# FINAL-004 — Deliver the First Vertical Slice

## Objective

Complete a reviewable engineering exercise that demonstrates **deliver the first vertical slice** and explain the decisions you made.

## Context

This is task 4 in the Final Project phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind deliver the first vertical slice.
...
1. Create or update the task artifact under `projects/final/final-004/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates deliver the first vertical slice.
...
- Primary workspace: `projects/final/final-004/`
- Evidence: `projects/final/final-004/README.md`
...
- [ ] The artifact directly demonstrates deliver the first vertical slice.
...
From the repository root, enter `projects/final/final-004` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[FINAL-004]`.
...
`task/<github-username>/final-004-deliver-the-first-vertical-slice`

## Commit Message

`project: complete final-004 deliver the first vertical slice`
