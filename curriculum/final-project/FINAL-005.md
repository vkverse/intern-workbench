...
id: FINAL-005
phase: FINAL
title: Implement Core Features through Focused Pull Requests
type: PROJECT
difficulty: advanced
guidance: AMBIGUOUS
...
Complete a reviewable engineering exercise that demonstrates **implement core features through focused pull requests** and explain the decisions you made.

## Context

This is task 5 in the Final Project phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind implement core features through focused pull requests.
...
1. Create or update the task artifact under `projects/final/final-005/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates implement core features through focused pull requests.
...
- Primary workspace: `projects/final/final-005/`
- Evidence: `projects/final/final-005/README.md`
...
- [ ] The artifact directly demonstrates implement core features through focused pull requests.
...
From the repository root, enter `projects/final/final-005` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[FINAL-005]`.
...
`project: complete final-005 implement core features through focused pull requests`
