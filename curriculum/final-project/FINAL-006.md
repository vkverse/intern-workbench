...
id: FINAL-006
phase: FINAL
title: Respond to a Requirement Change and Bug Report
type: PROJECT
difficulty: advanced
guidance: AMBIGUOUS
...
Complete a reviewable engineering exercise that demonstrates **respond to a requirement change and bug report** and explain the decisions you made.

## Context

This is task 6 in the Final Project phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind respond to a requirement change and bug report.
...
1. Create or update the task artifact under `projects/final/final-006/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates respond to a requirement change and bug report.
...
- Primary workspace: `projects/final/final-006/`
- Evidence: `projects/final/final-006/README.md`
...
- [ ] The artifact directly demonstrates respond to a requirement change and bug report.
...
From the repository root, enter `projects/final/final-006` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[FINAL-006]`.
...
`project: complete final-006 respond to a requirement change and bug report`
