...
id: FINAL-008
phase: FINAL
title: Prepare a Release, Demo, and Retrospective
type: PROJECT
difficulty: advanced
guidance: AMBIGUOUS
...
# FINAL-008 — Prepare a Release, Demo, and Retrospective

## Objective

Complete a reviewable engineering exercise that demonstrates **prepare a release, demo, and retrospective** and explain the decisions you made.

## Context

This is task 8 in the Final Project phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind prepare a release, demo, and retrospective.
...
1. Create or update the task artifact under `projects/final/final-008/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates prepare a release, demo, and retrospective.
...
- Primary workspace: `projects/final/final-008/`
- Evidence: `projects/final/final-008/README.md`
...
- [ ] The artifact directly demonstrates prepare a release, demo, and retrospective.
...
From the repository root, enter `projects/final/final-008` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[FINAL-008]`.
...
`project: complete final-008 prepare a release, demo, and retrospective`
