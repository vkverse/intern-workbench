...
# REACT-007 — Refs and Custom Hooks

## Objective

Complete a reviewable engineering exercise that demonstrates **refs and custom hooks** and explain the decisions you made.

## Context

This is task 7 in the React phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind refs and custom hooks.
...
1. Create or update the task artifact under `projects/intermediate/react-app/react-007/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates refs and custom hooks.
...
- Primary workspace: `projects/intermediate/react-app/react-007/`
- Evidence: `projects/intermediate/react-app/react-007/README.md`
...
- [ ] The artifact directly demonstrates refs and custom hooks.
...
From the repository root, enter `projects/intermediate/react-app/react-007` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[REACT-007]`.
...
`task/<github-username>/react-007-refs-and-custom-hooks`

## Commit Message

`build: complete react-007 refs and custom hooks`
