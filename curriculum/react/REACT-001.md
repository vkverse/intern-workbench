...
# REACT-001 — Components, JSX, and Props

## Objective

Complete a reviewable engineering exercise that demonstrates **components, jsx, and props** and explain the decisions you made.

## Context

This is task 1 in the React phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind components, jsx, and props.
...
1. Create or update the task artifact under `projects/intermediate/react-app/react-001/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates components, jsx, and props.
...
- Primary workspace: `projects/intermediate/react-app/react-001/`
- Evidence: `projects/intermediate/react-app/react-001/README.md`
...
- [ ] The artifact directly demonstrates components, jsx, and props.
...
From the repository root, enter `projects/intermediate/react-app/react-001` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[REACT-001]`.
...
`task/<github-username>/react-001-components-jsx-and-props`

## Commit Message

`build: complete react-001 components, jsx, and props`
