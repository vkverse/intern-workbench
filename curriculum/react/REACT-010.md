...
id: REACT-010
phase: REACT
title: Accessible Reusable Components
type: BUILD
...
Complete a reviewable engineering exercise that demonstrates **accessible reusable components** and explain the decisions you made.

## Context

This is task 10 in the React phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind accessible reusable components.
...
1. Create or update the task artifact under `projects/intermediate/react-app/react-010/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates accessible reusable components.
...
- Primary workspace: `projects/intermediate/react-app/react-010/`
- Evidence: `projects/intermediate/react-app/react-010/README.md`
...
- [ ] The artifact directly demonstrates accessible reusable components.
...
From the repository root, enter `projects/intermediate/react-app/react-010` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[REACT-010]`.
...
`task/<github-username>/react-010-accessible-reusable-components`

## Commit Message

`build: complete react-010 accessible reusable components`
