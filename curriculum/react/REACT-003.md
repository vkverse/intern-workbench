...
id: REACT-003
phase: REACT
title: Lists, Keys, and Composition
type: BUILD
...
# REACT-003 — Lists, Keys, and Composition

## Objective

Complete a reviewable engineering exercise that demonstrates **lists, keys, and composition** and explain the decisions you made.

## Context

This is task 3 in the React phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind lists, keys, and composition.
...
1. Create or update the task artifact under `projects/intermediate/react-app/react-003/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates lists, keys, and composition.
...
- Primary workspace: `projects/intermediate/react-app/react-003/`
- Evidence: `projects/intermediate/react-app/react-003/README.md`
...
- [ ] The artifact directly demonstrates lists, keys, and composition.
...
From the repository root, enter `projects/intermediate/react-app/react-003` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[REACT-003]`.
...
`build: complete react-003 lists, keys, and composition`
