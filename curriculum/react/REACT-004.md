...
# REACT-004 — Controlled Forms and Validation

## Objective

Complete a reviewable engineering exercise that demonstrates **controlled forms and validation** and explain the decisions you made.

## Context

This is task 4 in the React phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind controlled forms and validation.
...
1. Create or update the task artifact under `projects/intermediate/react-app/react-004/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates controlled forms and validation.
...
- Primary workspace: `projects/intermediate/react-app/react-004/`
- Evidence: `projects/intermediate/react-app/react-004/README.md`
...
- [ ] The artifact directly demonstrates controlled forms and validation.
...
From the repository root, enter `projects/intermediate/react-app/react-004` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[REACT-004]`.
...
`task/<github-username>/react-004-controlled-forms-and-validation`

## Commit Message

`build: complete react-004 controlled forms and validation`
