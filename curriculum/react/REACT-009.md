...
Complete a reviewable engineering exercise that demonstrates **memoization and rendering performance** and explain the decisions you made.

## Context

This is task 9 in the React phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind memoization and rendering performance.
...
1. Create or update the task artifact under `projects/intermediate/react-app/react-009/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates memoization and rendering performance.
...
- Primary workspace: `projects/intermediate/react-app/react-009/`
- Evidence: `projects/intermediate/react-app/react-009/README.md`
...
- [ ] The artifact directly demonstrates memoization and rendering performance.
...
From the repository root, enter `projects/intermediate/react-app/react-009` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[REACT-009]`.
...
`build: complete react-009 memoization and rendering performance`
