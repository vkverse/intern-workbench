...
id: REACT-005
phase: REACT
title: Effects and API Integration
type: BUILD
...
Complete a reviewable engineering exercise that demonstrates **effects and api integration** and explain the decisions you made.

## Context

This is task 5 in the React phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind effects and api integration.
...
1. Create or update the task artifact under `projects/intermediate/react-app/react-005/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates effects and api integration.
...
- Primary workspace: `projects/intermediate/react-app/react-005/`
- Evidence: `projects/intermediate/react-app/react-005/README.md`
...
- [ ] The artifact directly demonstrates effects and api integration.
...
From the repository root, enter `projects/intermediate/react-app/react-005` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[REACT-005]`.
...
`build: complete react-005 effects and api integration`
