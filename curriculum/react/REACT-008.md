...
id: REACT-008
phase: REACT
title: Context and State Boundaries
type: BUILD
...
# REACT-008 — Context and State Boundaries

## Objective

Complete a reviewable engineering exercise that demonstrates **context and state boundaries** and explain the decisions you made.

## Context

This is task 8 in the React phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind context and state boundaries.
...
1. Create or update the task artifact under `projects/intermediate/react-app/react-008/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates context and state boundaries.
...
- Primary workspace: `projects/intermediate/react-app/react-008/`
- Evidence: `projects/intermediate/react-app/react-008/README.md`
...
- [ ] The artifact directly demonstrates context and state boundaries.
...
From the repository root, enter `projects/intermediate/react-app/react-008` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[REACT-008]`.
...
`task/<github-username>/react-008-context-and-state-boundaries`

## Commit Message

`build: complete react-008 context and state boundaries`
