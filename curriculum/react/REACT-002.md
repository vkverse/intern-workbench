...
id: REACT-002
phase: REACT
title: State, Events, and Conditional Rendering
type: BUILD
...
# REACT-002 — State, Events, and Conditional Rendering

## Objective

Complete a reviewable engineering exercise that demonstrates **state, events, and conditional rendering** and explain the decisions you made.

## Context

This is task 2 in the React phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind state, events, and conditional rendering.
...
1. Create or update the task artifact under `projects/intermediate/react-app/react-002/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates state, events, and conditional rendering.
...
- Primary workspace: `projects/intermediate/react-app/react-002/`
- Evidence: `projects/intermediate/react-app/react-002/README.md`
...
Preserve accessibility and keep state at the narrowest useful boundary.
...
- [ ] The artifact directly demonstrates state, events, and conditional rendering.
...
From the repository root, enter `projects/intermediate/react-app/react-002` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[REACT-002]`.
...
`task/<github-username>/react-002-state-events-and-conditional-rendering`

## Commit Message

`build: complete react-002 state, events, and conditional rendering`
