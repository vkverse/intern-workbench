...
# REACT-006 — Loading, Error, and Empty States

## Objective

Complete a reviewable engineering exercise that demonstrates **loading, error, and empty states** and explain the decisions you made.

## Context

This is task 6 in the React phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind loading, error, and empty states.
...
1. Create or update the task artifact under `projects/intermediate/react-app/react-006/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates loading, error, and empty states.
...
- Primary workspace: `projects/intermediate/react-app/react-006/`
- Evidence: `projects/intermediate/react-app/react-006/README.md`
...
- [ ] The artifact directly demonstrates loading, error, and empty states.
...
From the repository root, enter `projects/intermediate/react-app/react-006` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[REACT-006]`.
...
`task/<github-username>/react-006-loading-error-and-empty-states`

## Commit Message

`build: complete react-006 loading, error, and empty states`
