...
id: DB-006
phase: DB
title: Constraints, Transactions, and Integrity
type: BUILD
...
# DB-006 — Constraints, Transactions, and Integrity

## Objective

Complete a reviewable engineering exercise that demonstrates **constraints, transactions, and integrity** and explain the decisions you made.

## Context

This is task 6 in the PostgreSQL and Databases phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind constraints, transactions, and integrity.
...
1. Create or update the task artifact under `projects/full-stack/database/db-006/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates constraints, transactions, and integrity.
...
- Primary workspace: `projects/full-stack/database/db-006/`
- Evidence: `projects/full-stack/database/db-006/README.md`
...
- [ ] The artifact directly demonstrates constraints, transactions, and integrity.
...
From the repository root, enter `projects/full-stack/database/db-006` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[DB-006]`.
...
`task/<github-username>/db-006-constraints-transactions-and-integrity`

## Commit Message

`build: complete db-006 constraints, transactions, and integrity`
