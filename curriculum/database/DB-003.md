...
id: DB-003
phase: DB
title: Write with INSERT, UPDATE, and DELETE
type: BUILD
...
# DB-003 — Write with INSERT, UPDATE, and DELETE

## Objective

Complete a reviewable engineering exercise that demonstrates **write with insert, update, and delete** and explain the decisions you made.

## Context

This is task 3 in the PostgreSQL and Databases phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind write with insert, update, and delete.
...
1. Create or update the task artifact under `projects/full-stack/database/db-003/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates write with insert, update, and delete.
...
- Primary workspace: `projects/full-stack/database/db-003/`
- Evidence: `projects/full-stack/database/db-003/README.md`
...
- [ ] The artifact directly demonstrates write with insert, update, and delete.
...
From the repository root, enter `projects/full-stack/database/db-003` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[DB-003]`.
...
`task/<github-username>/db-003-write-with-insert-update-and-delete`

## Commit Message

`build: complete db-003 write with insert, update, and delete`
