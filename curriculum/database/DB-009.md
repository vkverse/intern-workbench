...
id: DB-009
phase: DB
title: Migrations, Seeds, and ORM Fundamentals
type: BUILD
...
# DB-009 — Migrations, Seeds, and ORM Fundamentals

## Objective

Complete a reviewable engineering exercise that demonstrates **migrations, seeds, and orm fundamentals** and explain the decisions you made.

## Context

This is task 9 in the PostgreSQL and Databases phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind migrations, seeds, and orm fundamentals.
...
1. Create or update the task artifact under `projects/full-stack/database/db-009/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates migrations, seeds, and orm fundamentals.
...
- Primary workspace: `projects/full-stack/database/db-009/`
- Evidence: `projects/full-stack/database/db-009/README.md`
...
- [ ] The artifact directly demonstrates migrations, seeds, and orm fundamentals.
...
From the repository root, enter `projects/full-stack/database/db-009` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[DB-009]`.
...
`task/<github-username>/db-009-migrations-seeds-and-orm-fundamentals`

## Commit Message

`build: complete db-009 migrations, seeds, and orm fundamentals`
