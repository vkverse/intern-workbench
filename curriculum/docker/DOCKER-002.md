...
id: DOCKER-002
phase: DOCKER
title: Ports, Volumes, and Environment Variables
type: BUILD
difficulty: advanced
...
Complete a reviewable engineering exercise that demonstrates **ports, volumes, and environment variables** and explain the decisions you made.

## Context

This is task 2 in the Docker phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind ports, volumes, and environment variables.
...
1. Create or update the task artifact under `projects/full-stack/docker-002/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates ports, volumes, and environment variables.
...
- Primary workspace: `projects/full-stack/docker-002/`
- Evidence: `projects/full-stack/docker-002/README.md`
...
- [ ] The artifact directly demonstrates ports, volumes, and environment variables.
...
From the repository root, enter `projects/full-stack/docker-002` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[DOCKER-002]`.
...
`build: complete docker-002 ports, volumes, and environment variables`
