...
Complete a reviewable engineering exercise that demonstrates **images, containers, and dockerfiles** and explain the decisions you made.

## Context

This is task 1 in the Docker phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind images, containers, and dockerfiles.
...
1. Create or update the task artifact under `projects/full-stack/docker-001/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates images, containers, and dockerfiles.
...
- Primary workspace: `projects/full-stack/docker-001/`
- Evidence: `projects/full-stack/docker-001/README.md`
...
- [ ] The artifact directly demonstrates images, containers, and dockerfiles.
...
From the repository root, enter `projects/full-stack/docker-001` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[DOCKER-001]`.
...
`task/<github-username>/docker-001-images-containers-and-dockerfiles`

## Commit Message

`build: complete docker-001 images, containers, and dockerfiles`
