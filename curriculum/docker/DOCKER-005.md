...
id: DOCKER-005
phase: DOCKER
title: Compose an App with PostgreSQL
type: BUILD
difficulty: advanced
...
Complete a reviewable engineering exercise that demonstrates **compose an app with postgresql** and explain the decisions you made.

## Context

This is task 5 in the Docker phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind compose an app with postgresql.
...
1. Create or update the task artifact under `projects/full-stack/docker-005/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates compose an app with postgresql.
...
- Primary workspace: `projects/full-stack/docker-005/`
- Evidence: `projects/full-stack/docker-005/README.md`
...
- [ ] The artifact directly demonstrates compose an app with postgresql.
...
From the repository root, enter `projects/full-stack/docker-005` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[DOCKER-005]`.
...
`task/<github-username>/docker-005-compose-an-app-with-postgresql`

## Commit Message

`build: complete docker-005 compose an app with postgresql`
