...
id: DOCKER-006
phase: DOCKER
title: Debug and Document a Full Local Environment
type: BUILD
difficulty: advanced
...
# DOCKER-006 — Debug and Document a Full Local Environment

## Objective

Complete a reviewable engineering exercise that demonstrates **debug and document a full local environment** and explain the decisions you made.

## Context

This is task 6 in the Docker phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind debug and document a full local environment.
...
1. Create or update the task artifact under `projects/full-stack/docker-006/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates debug and document a full local environment.
...
- Primary workspace: `projects/full-stack/docker-006/`
- Evidence: `projects/full-stack/docker-006/README.md`
...
Pin base images, exclude secrets, and document host/container differences.
...
- [ ] The artifact directly demonstrates debug and document a full local environment.
...
From the repository root, enter `projects/full-stack/docker-006` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[DOCKER-006]`.
...
`build: complete docker-006 debug and document a full local environment`
