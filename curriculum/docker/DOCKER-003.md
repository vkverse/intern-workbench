...
# DOCKER-003 — Containerize a Frontend

## Objective

Complete a reviewable engineering exercise that demonstrates **containerize a frontend** and explain the decisions you made.

## Context

This is task 3 in the Docker phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind containerize a frontend.
...
1. Create or update the task artifact under `projects/full-stack/docker-003/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates containerize a frontend.
...
- Primary workspace: `projects/full-stack/docker-003/`
- Evidence: `projects/full-stack/docker-003/README.md`
...
- [ ] The artifact directly demonstrates containerize a frontend.
...
From the repository root, enter `projects/full-stack/docker-003` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[DOCKER-003]`.
...
`build: complete docker-003 containerize a frontend`
