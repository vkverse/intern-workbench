...
# CSS-002 — Colors, Units, and Typography

## Objective

Complete a reviewable engineering exercise that demonstrates **colors, units, and typography** and explain the decisions you made.

## Context

This is task 2 in the CSS phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind colors, units, and typography.
...
1. Create or update the task artifact under `projects/beginner/site/css-002/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates colors, units, and typography.
...
- Primary workspace: `projects/beginner/site/css-002/`
- Evidence: `projects/beginner/site/css-002/README.md`
...
- [ ] The artifact directly demonstrates colors, units, and typography.
...
From the repository root, enter `projects/beginner/site/css-002` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[CSS-002]`.
...
`task/<github-username>/css-002-colors-units-and-typography`

## Commit Message

`build: complete css-002 colors, units, and typography`
