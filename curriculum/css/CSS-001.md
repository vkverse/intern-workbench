...
id: CSS-001
phase: CSS
title: Selectors, Cascade, Specificity, and Inheritance
type: BUILD
difficulty: beginner
guidance: GUIDED
...
# CSS-001 — Selectors, Cascade, Specificity, and Inheritance

## Objective

Complete a reviewable engineering exercise that demonstrates **selectors, cascade, specificity, and inheritance** and explain the decisions you made.

## Context

This is task 1 in the CSS phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind selectors, cascade, specificity, and inheritance.
...
1. Create or update the task artifact under `projects/beginner/site/css-001/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates selectors, cascade, specificity, and inheritance.
...
- Primary workspace: `projects/beginner/site/css-001/`
- Evidence: `projects/beginner/site/css-001/README.md`
...
For reference work: no unrequested shadows, gradients, cards, decoration, spacing changes, or animation.
...
- [ ] The artifact directly demonstrates selectors, cascade, specificity, and inheritance.
...
From the repository root, enter `projects/beginner/site/css-001` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[CSS-001]`.
...
`task/<github-username>/css-001-selectors-cascade-specificity-and-inherita`

## Commit Message

`build: complete css-001 selectors, cascade, specificity, and inheritance`
