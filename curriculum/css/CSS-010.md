...
id: CSS-010
phase: CSS
title: Refactor and Audit a Dashboard UI
type: BUILD
difficulty: beginner
guidance: GUIDED
...
# CSS-010 — Refactor and Audit a Dashboard UI

## Objective

Complete a reviewable engineering exercise that demonstrates **refactor and audit a dashboard ui** and explain the decisions you made.

## Context

This is task 10 in the CSS phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind refactor and audit a dashboard ui.
...
1. Create or update the task artifact under `projects/beginner/site/css-010/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates refactor and audit a dashboard ui.
...
- Primary workspace: `projects/beginner/site/css-010/`
- Evidence: `projects/beginner/site/css-010/README.md`
...
- [ ] The artifact directly demonstrates refactor and audit a dashboard ui.
...
From the repository root, enter `projects/beginner/site/css-010` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[CSS-010]`.
...
`task/<github-username>/css-010-refactor-and-audit-a-dashboard-ui`

## Commit Message

`build: complete css-010 refactor and audit a dashboard ui`
