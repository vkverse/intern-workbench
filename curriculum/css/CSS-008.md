...
id: CSS-008
phase: CSS
title: Variables, Components, and Interaction States
type: BUILD
difficulty: beginner
guidance: GUIDED
...
# CSS-008 — Variables, Components, and Interaction States

## Objective

Complete a reviewable engineering exercise that demonstrates **variables, components, and interaction states** and explain the decisions you made.

## Context

This is task 8 in the CSS phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind variables, components, and interaction states.
...
1. Create or update the task artifact under `projects/beginner/site/css-008/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates variables, components, and interaction states.
...
- Primary workspace: `projects/beginner/site/css-008/`
- Evidence: `projects/beginner/site/css-008/README.md`
...
- [ ] The artifact directly demonstrates variables, components, and interaction states.
...
From the repository root, enter `projects/beginner/site/css-008` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[CSS-008]`.
...
`task/<github-username>/css-008-variables-components-and-interaction-state`

## Commit Message

`build: complete css-008 variables, components, and interaction states`
