...
id: CSS-009
phase: CSS
title: Recreate a Reference Design Faithfully
type: BUILD
difficulty: beginner
guidance: GUIDED
...
# CSS-009 — Recreate a Reference Design Faithfully

## Objective

Complete a reviewable engineering exercise that demonstrates **recreate a reference design faithfully** and explain the decisions you made.

## Context

This is task 9 in the CSS phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind recreate a reference design faithfully.
...
1. Create or update the task artifact under `projects/beginner/site/css-009/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates recreate a reference design faithfully.
...
- Primary workspace: `projects/beginner/site/css-009/`
- Evidence: `projects/beginner/site/css-009/README.md`
...
- [ ] The artifact directly demonstrates recreate a reference design faithfully.
...
From the repository root, enter `projects/beginner/site/css-009` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[CSS-009]`.
...
`task/<github-username>/css-009-recreate-a-reference-design-faithfully`

## Commit Message

`build: complete css-009 recreate a reference design faithfully`
