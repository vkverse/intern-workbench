...
id: CSS-003
phase: CSS
title: Box Model, Spacing, and Borders
type: BUILD
difficulty: beginner
guidance: GUIDED
...
# CSS-003 — Box Model, Spacing, and Borders

## Objective

Complete a reviewable engineering exercise that demonstrates **box model, spacing, and borders** and explain the decisions you made.

## Context

This is task 3 in the CSS phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind box model, spacing, and borders.
...
1. Create or update the task artifact under `projects/beginner/site/css-003/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates box model, spacing, and borders.
...
- Primary workspace: `projects/beginner/site/css-003/`
- Evidence: `projects/beginner/site/css-003/README.md`
...
- [ ] The artifact directly demonstrates box model, spacing, and borders.
...
From the repository root, enter `projects/beginner/site/css-003` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[CSS-003]`.
...
`task/<github-username>/css-003-box-model-spacing-and-borders`

## Commit Message

`build: complete css-003 box model, spacing, and borders`
