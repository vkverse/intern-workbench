...
# CSS-004 — Display and Positioning

## Objective

Complete a reviewable engineering exercise that demonstrates **display and positioning** and explain the decisions you made.

## Context

This is task 4 in the CSS phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind display and positioning.
...
1. Create or update the task artifact under `projects/beginner/site/css-004/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates display and positioning.
...
- Primary workspace: `projects/beginner/site/css-004/`
- Evidence: `projects/beginner/site/css-004/README.md`
...
- [ ] The artifact directly demonstrates display and positioning.
...
From the repository root, enter `projects/beginner/site/css-004` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[CSS-004]`.
...
`task/<github-username>/css-004-display-and-positioning`

## Commit Message

`build: complete css-004 display and positioning`
