...
id: API-001
phase: API
title: Model Resources, Routes, and Methods
type: BUILD
...
# API-001 — Model Resources, Routes, and Methods

## Objective

Complete a reviewable engineering exercise that demonstrates **model resources, routes, and methods** and explain the decisions you made.

## Context

This is task 1 in the REST APIs phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind model resources, routes, and methods.
...
1. Create or update the task artifact under `projects/full-stack/api/api-001/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates model resources, routes, and methods.
...
- Primary workspace: `projects/full-stack/api/api-001/`
- Evidence: `projects/full-stack/api/api-001/README.md`
...
- [ ] The artifact directly demonstrates model resources, routes, and methods.
...
From the repository root, enter `projects/full-stack/api/api-001` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[API-001]`.
...
`task/<github-username>/api-001-model-resources-routes-and-methods`

## Commit Message

`build: complete api-001 model resources, routes, and methods`
