...
id: PERF-002
phase: PERF
title: Profile Frontend Rendering and Bundles
type: INVESTIGATE
difficulty: advanced
...
Complete a reviewable engineering exercise that demonstrates **profile frontend rendering and bundles** and explain the decisions you made.

## Context

This is task 2 in the Performance phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind profile frontend rendering and bundles.
...
1. Create or update the task artifact under `projects/advanced/performance-lab/perf-002/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates profile frontend rendering and bundles.
...
- Primary workspace: `projects/advanced/performance-lab/perf-002/`
- Evidence: `projects/advanced/performance-lab/perf-002/README.md`
...
- [ ] The artifact directly demonstrates profile frontend rendering and bundles.
...
From the repository root, enter `projects/advanced/performance-lab/perf-002` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[PERF-002]`.
...
`task/<github-username>/perf-002-profile-frontend-rendering-and-bundles`

## Commit Message

`investigate: complete perf-002 profile frontend rendering and bundles`
