...
# PERF-004 — Profile API Bottlenecks

## Objective

Complete a reviewable engineering exercise that demonstrates **profile api bottlenecks** and explain the decisions you made.

## Context

This is task 4 in the Performance phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind profile api bottlenecks.
...
1. Create or update the task artifact under `projects/advanced/performance-lab/perf-004/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates profile api bottlenecks.
...
- Primary workspace: `projects/advanced/performance-lab/perf-004/`
- Evidence: `projects/advanced/performance-lab/perf-004/README.md`
...
- [ ] The artifact directly demonstrates profile api bottlenecks.
...
From the repository root, enter `projects/advanced/performance-lab/perf-004` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[PERF-004]`.
...
`task/<github-username>/perf-004-profile-api-bottlenecks`

## Commit Message

`investigate: complete perf-004 profile api bottlenecks`
