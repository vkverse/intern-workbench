...
id: PERF-006
phase: PERF
title: Implement Caching and Prove the Improvement
type: INVESTIGATE
difficulty: advanced
...
# PERF-006 — Implement Caching and Prove the Improvement

## Objective

Complete a reviewable engineering exercise that demonstrates **implement caching and prove the improvement** and explain the decisions you made.

## Context

This is task 6 in the Performance phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind implement caching and prove the improvement.
...
1. Create or update the task artifact under `projects/advanced/performance-lab/perf-006/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates implement caching and prove the improvement.
...
- Primary workspace: `projects/advanced/performance-lab/perf-006/`
- Evidence: `projects/advanced/performance-lab/perf-006/README.md`
...
Measure before and after; do not claim an improvement without comparable evidence.
...
- [ ] The artifact directly demonstrates implement caching and prove the improvement.
...
From the repository root, enter `projects/advanced/performance-lab/perf-006` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[PERF-006]`.
...
`task/<github-username>/perf-006-implement-caching-and-prove-the-improvemen`

## Commit Message

`investigate: complete perf-006 implement caching and prove the improvement`
