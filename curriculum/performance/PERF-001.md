...
# PERF-001 — Establish a Performance Baseline

## Objective

Complete a reviewable engineering exercise that demonstrates **establish a performance baseline** and explain the decisions you made.

## Context

This is task 1 in the Performance phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind establish a performance baseline.
...
1. Create or update the task artifact under `projects/advanced/performance-lab/perf-001/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates establish a performance baseline.
...
- Primary workspace: `projects/advanced/performance-lab/perf-001/`
- Evidence: `projects/advanced/performance-lab/perf-001/README.md`
...
- [ ] The artifact directly demonstrates establish a performance baseline.
...
From the repository root, enter `projects/advanced/performance-lab/perf-001` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[PERF-001]`.
...
`investigate: complete perf-001 establish a performance baseline`
