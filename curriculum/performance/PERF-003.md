...
id: PERF-003
phase: PERF
title: Optimize Network, Images, and Lazy Loading
type: INVESTIGATE
difficulty: advanced
...
Complete a reviewable engineering exercise that demonstrates **optimize network, images, and lazy loading** and explain the decisions you made.

## Context

This is task 3 in the Performance phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind optimize network, images, and lazy loading.
...
1. Create or update the task artifact under `projects/advanced/performance-lab/perf-003/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates optimize network, images, and lazy loading.
...
- Primary workspace: `projects/advanced/performance-lab/perf-003/`
- Evidence: `projects/advanced/performance-lab/perf-003/README.md`
...
- [ ] The artifact directly demonstrates optimize network, images, and lazy loading.
...
From the repository root, enter `projects/advanced/performance-lab/perf-003` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[PERF-003]`.
...
`investigate: complete perf-003 optimize network, images, and lazy loading`
