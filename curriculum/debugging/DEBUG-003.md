...
id: DEBUG-003
phase: DEBUG
title: Use Breakpoints and Stack Traces
type: DEBUG
difficulty: advanced
...
Complete a reviewable engineering exercise that demonstrates **use breakpoints and stack traces** and explain the decisions you made.

## Context

This is task 3 in the Debugging phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind use breakpoints and stack traces.
...
1. Create or update the task artifact under `projects/advanced/incident-lab/debug-003/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates use breakpoints and stack traces.
...
- Primary workspace: `projects/advanced/incident-lab/debug-003/`
- Evidence: `projects/advanced/incident-lab/debug-003/README.md`
...
- [ ] The artifact directly demonstrates use breakpoints and stack traces.
...
From the repository root, enter `projects/advanced/incident-lab/debug-003` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[DEBUG-003]`.
...
`debug: complete debug-003 use breakpoints and stack traces`
