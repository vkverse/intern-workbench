...
id: DEBUG-007
phase: DEBUG
title: Repair a CI or Performance Failure
type: DEBUG
difficulty: advanced
...
# DEBUG-007 — Repair a CI or Performance Failure

## Objective

Complete a reviewable engineering exercise that demonstrates **repair a ci or performance failure** and explain the decisions you made.

## Context

This is task 7 in the Debugging phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind repair a ci or performance failure.
...
1. Create or update the task artifact under `projects/advanced/incident-lab/debug-007/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates repair a ci or performance failure.
...
- Primary workspace: `projects/advanced/incident-lab/debug-007/`
- Evidence: `projects/advanced/incident-lab/debug-007/README.md`
...
- [ ] The artifact directly demonstrates repair a ci or performance failure.
...
From the repository root, enter `projects/advanced/incident-lab/debug-007` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[DEBUG-007]`.
...
`task/<github-username>/debug-007-repair-a-ci-or-performance-failure`

## Commit Message

`debug: complete debug-007 repair a ci or performance failure`
