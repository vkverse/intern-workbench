...
id: DEBUG-006
phase: DEBUG
title: Diagnose Authentication and Environment Failures
type: DEBUG
difficulty: advanced
...
# DEBUG-006 — Diagnose Authentication and Environment Failures

## Objective

Complete a reviewable engineering exercise that demonstrates **diagnose authentication and environment failures** and explain the decisions you made.

## Context

This is task 6 in the Debugging phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind diagnose authentication and environment failures.
...
1. Create or update the task artifact under `projects/advanced/incident-lab/debug-006/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates diagnose authentication and environment failures.
...
- Primary workspace: `projects/advanced/incident-lab/debug-006/`
- Evidence: `projects/advanced/incident-lab/debug-006/README.md`
...
Document problem, reproduction, investigation, root cause, fix, verification, and prevention.
...
- [ ] The artifact directly demonstrates diagnose authentication and environment failures.
...
From the repository root, enter `projects/advanced/incident-lab/debug-006` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[DEBUG-006]`.
...
`task/<github-username>/debug-006-diagnose-authentication-and-environment-fa`

## Commit Message

`debug: complete debug-006 diagnose authentication and environment failures`
