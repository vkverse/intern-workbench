...
id: DEBUG-001
phase: DEBUG
title: Use a Repeatable Debugging Method
type: DEBUG
difficulty: advanced
...
Complete a reviewable engineering exercise that demonstrates **use a repeatable debugging method** and explain the decisions you made.

## Context

This is task 1 in the Debugging phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind use a repeatable debugging method.
...
1. Create or update the task artifact under `projects/advanced/incident-lab/debug-001/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates use a repeatable debugging method.
...
- Primary workspace: `projects/advanced/incident-lab/debug-001/`
- Evidence: `projects/advanced/incident-lab/debug-001/README.md`
...
- [ ] The artifact directly demonstrates use a repeatable debugging method.
...
From the repository root, enter `projects/advanced/incident-lab/debug-001` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[DEBUG-001]`.
...
`debug: complete debug-001 use a repeatable debugging method`
