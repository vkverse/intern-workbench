...
id: DEBUG-008
phase: DEBUG
title: Run a Production-Like Incident and Write the RCA
type: DEBUG
difficulty: advanced
...
Complete a reviewable engineering exercise that demonstrates **run a production-like incident and write the rca** and explain the decisions you made.

## Context

This is task 8 in the Debugging phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind run a production-like incident and write the rca.
...
1. Create or update the task artifact under `projects/advanced/incident-lab/debug-008/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates run a production-like incident and write the rca.
...
- Primary workspace: `projects/advanced/incident-lab/debug-008/`
- Evidence: `projects/advanced/incident-lab/debug-008/README.md`
...
- [ ] The artifact directly demonstrates run a production-like incident and write the rca.
...
From the repository root, enter `projects/advanced/incident-lab/debug-008` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[DEBUG-008]`.
...
`task/<github-username>/debug-008-run-a-production-like-incident-and-write-t`

## Commit Message

`debug: complete debug-008 run a production-like incident and write the rca`
