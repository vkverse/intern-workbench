...
id: DEBUG-002
phase: DEBUG
title: Debug with Browser DevTools and the Console
type: DEBUG
difficulty: advanced
...
Complete a reviewable engineering exercise that demonstrates **debug with browser devtools and the console** and explain the decisions you made.

## Context

This is task 2 in the Debugging phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind debug with browser devtools and the console.
...
1. Create or update the task artifact under `projects/advanced/incident-lab/debug-002/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates debug with browser devtools and the console.
...
- Primary workspace: `projects/advanced/incident-lab/debug-002/`
- Evidence: `projects/advanced/incident-lab/debug-002/README.md`
...
- [ ] The artifact directly demonstrates debug with browser devtools and the console.
...
From the repository root, enter `projects/advanced/incident-lab/debug-002` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[DEBUG-002]`.
...
`debug: complete debug-002 debug with browser devtools and the console`
