...
id: GIT-011
phase: GIT
title: Labels, Milestones, CODEOWNERS, and Protection
type: BUILD
difficulty: beginner
guidance: GUIDED
...
# GIT-011 — Labels, Milestones, CODEOWNERS, and Protection

## Objective

Complete a reviewable engineering exercise that demonstrates **labels, milestones, codeowners, and protection** and explain the decisions you made.

## Context

This is task 11 in the Git and GitHub phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind labels, milestones, codeowners, and protection.
...
1. Create or update the task artifact under `practice/git-lab/git-011/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates labels, milestones, codeowners, and protection.
...
- Primary workspace: `practice/git-lab/git-011/`
- Evidence: `practice/git-lab/git-011/README.md`
...
- [ ] The artifact directly demonstrates labels, milestones, codeowners, and protection.
...
From the repository root, enter `practice/git-lab/git-011` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[GIT-011]`.
...
`task/<github-username>/git-011-labels-milestones-codeowners-and-protectio`

## Commit Message

`build: complete git-011 labels, milestones, codeowners, and protection`
