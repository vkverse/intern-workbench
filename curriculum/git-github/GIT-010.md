...
id: GIT-010
phase: GIT
title: Review and Respond to a Pull Request
type: BUILD
difficulty: beginner
guidance: GUIDED
...
# GIT-010 — Review and Respond to a Pull Request

## Objective

Complete a reviewable engineering exercise that demonstrates **review and respond to a pull request** and explain the decisions you made.

## Context

This is task 10 in the Git and GitHub phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind review and respond to a pull request.
...
1. Create or update the task artifact under `practice/git-lab/git-010/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates review and respond to a pull request.
...
- Primary workspace: `practice/git-lab/git-010/`
- Evidence: `practice/git-lab/git-010/README.md`
...
- [ ] The artifact directly demonstrates review and respond to a pull request.
...
From the repository root, enter `practice/git-lab/git-010` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[GIT-010]`.
...
`task/<github-username>/git-010-review-and-respond-to-a-pull-request`

## Commit Message

`build: complete git-010 review and respond to a pull request`
