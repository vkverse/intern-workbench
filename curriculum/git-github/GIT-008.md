...
id: GIT-008
phase: GIT
title: Forks, Origin, and Upstream
type: BUILD
difficulty: beginner
guidance: GUIDED
...
# GIT-008 — Forks, Origin, and Upstream

## Objective

Complete a reviewable engineering exercise that demonstrates **forks, origin, and upstream** and explain the decisions you made.

## Context

This is task 8 in the Git and GitHub phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind forks, origin, and upstream.
...
1. Create or update the task artifact under `practice/git-lab/git-008/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates forks, origin, and upstream.
...
- Primary workspace: `practice/git-lab/git-008/`
- Evidence: `practice/git-lab/git-008/README.md`
...
- [ ] The artifact directly demonstrates forks, origin, and upstream.
...
From the repository root, enter `practice/git-lab/git-008` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[GIT-008]`.
...
`task/<github-username>/git-008-forks-origin-and-upstream`

## Commit Message

`build: complete git-008 forks, origin, and upstream`
