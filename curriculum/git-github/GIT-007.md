...
id: GIT-007
phase: GIT
title: Clone, Push, Pull, and Remotes
type: BUILD
difficulty: beginner
guidance: GUIDED
...
# GIT-007 — Clone, Push, Pull, and Remotes

## Objective

Complete a reviewable engineering exercise that demonstrates **clone, push, pull, and remotes** and explain the decisions you made.

## Context

This is task 7 in the Git and GitHub phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind clone, push, pull, and remotes.
...
1. Create or update the task artifact under `practice/git-lab/git-007/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates clone, push, pull, and remotes.
...
- Primary workspace: `practice/git-lab/git-007/`
- Evidence: `practice/git-lab/git-007/README.md`
...
- [ ] The artifact directly demonstrates clone, push, pull, and remotes.
...
From the repository root, enter `practice/git-lab/git-007` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[GIT-007]`.
...
`task/<github-username>/git-007-clone-push-pull-and-remotes`

## Commit Message

`build: complete git-007 clone, push, pull, and remotes`
