...
id: GIT-005
phase: GIT
title: Create, Switch, and Merge Branches
type: BUILD
difficulty: beginner
guidance: GUIDED
...
# GIT-005 — Create, Switch, and Merge Branches

## Objective

Complete a reviewable engineering exercise that demonstrates **create, switch, and merge branches** and explain the decisions you made.

## Context

This is task 5 in the Git and GitHub phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind create, switch, and merge branches.
...
1. Create or update the task artifact under `practice/git-lab/git-005/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates create, switch, and merge branches.
...
- Primary workspace: `practice/git-lab/git-005/`
- Evidence: `practice/git-lab/git-005/README.md`
...
- [ ] The artifact directly demonstrates create, switch, and merge branches.
...
From the repository root, enter `practice/git-lab/git-005` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[GIT-005]`.
...
`task/<github-username>/git-005-create-switch-and-merge-branches`

## Commit Message

`build: complete git-005 create, switch, and merge branches`
