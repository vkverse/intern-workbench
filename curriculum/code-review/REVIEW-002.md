...
id: REVIEW-002
phase: REVIEW
title: Review Architecture and Maintainability
type: REVIEW
difficulty: advanced
...
Complete a reviewable engineering exercise that demonstrates **review architecture and maintainability** and explain the decisions you made.

## Context

This is task 2 in the Code Review phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind review architecture and maintainability.
...
1. Create or update the task artifact under `projects/advanced/review-fixtures/review-002/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates review architecture and maintainability.
...
- Primary workspace: `projects/advanced/review-fixtures/review-002/`
- Evidence: `projects/advanced/review-fixtures/review-002/README.md`
...
- [ ] The artifact directly demonstrates review architecture and maintainability.
...
From the repository root, enter `projects/advanced/review-fixtures/review-002` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[REVIEW-002]`.
...
`task/<github-username>/review-002-review-architecture-and-maintainability`

## Commit Message

`review: complete review-002 review architecture and maintainability`
