...
id: REVIEW-003
phase: REVIEW
title: Review Security and Performance
type: REVIEW
difficulty: advanced
...
# REVIEW-003 — Review Security and Performance

## Objective

Complete a reviewable engineering exercise that demonstrates **review security and performance** and explain the decisions you made.

## Context

This is task 3 in the Code Review phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind review security and performance.
...
1. Create or update the task artifact under `projects/advanced/review-fixtures/review-003/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates review security and performance.
...
- Primary workspace: `projects/advanced/review-fixtures/review-003/`
- Evidence: `projects/advanced/review-fixtures/review-003/README.md`
...
- [ ] The artifact directly demonstrates review security and performance.
...
From the repository root, enter `projects/advanced/review-fixtures/review-003` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[REVIEW-003]`.
...
`task/<github-username>/review-003-review-security-and-performance`

## Commit Message

`review: complete review-003 review security and performance`
