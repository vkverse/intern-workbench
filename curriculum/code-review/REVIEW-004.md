...
id: REVIEW-004
phase: REVIEW
title: Review Tests and Missing Edge Cases
type: REVIEW
difficulty: advanced
...
# REVIEW-004 — Review Tests and Missing Edge Cases

## Objective

Complete a reviewable engineering exercise that demonstrates **review tests and missing edge cases** and explain the decisions you made.

## Context

This is task 4 in the Code Review phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind review tests and missing edge cases.
...
1. Create or update the task artifact under `projects/advanced/review-fixtures/review-004/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates review tests and missing edge cases.
...
- Primary workspace: `projects/advanced/review-fixtures/review-004/`
- Evidence: `projects/advanced/review-fixtures/review-004/README.md`
...
- [ ] The artifact directly demonstrates review tests and missing edge cases.
...
From the repository root, enter `projects/advanced/review-fixtures/review-004` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[REVIEW-004]`.
...
`review: complete review-004 review tests and missing edge cases`
